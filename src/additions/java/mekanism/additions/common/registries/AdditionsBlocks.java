...
public class AdditionsBlocks {
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockGlowPanel, BlockItem>> GLOW_PANELS = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockGlowPanel::new, "_glow_panel", color));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlastic, BlockItem>> PLASTIC_BLOCKS = EnumColorCollection.VALUES
          .map(color -> registerPlastic(color, "_plastic", properties -> properties.strength(5, 6)));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlastic, BlockItem>> SLICK_PLASTIC_BLOCKS = EnumColorCollection.VALUES
          .map(color -> registerPlastic(color, "_slick_plastic", properties -> properties.strength(5, 6).friction(0.98F)));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlastic, BlockItem>> PLASTIC_GLOW_BLOCKS = EnumColorCollection.VALUES
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockPlastic, BlockItem>> REINFORCED_PLASTIC_BLOCKS = EnumColorCollection.VALUES
          .map(color -> registerPlastic(color, "_reinforced_plastic", properties -> properties.strength(50, 1_200)));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticRoad, BlockItem>> PLASTIC_ROADS = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockPlasticRoad::new, "_plastic_road", color));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticTransparent, BlockItem>> TRANSPARENT_PLASTIC_BLOCKS = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockPlasticTransparent::new, "_plastic_transparent", color));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticStairs, BlockItem>> PLASTIC_STAIRS = EnumColorCollection.zipMap(
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticSlab, BlockItem>> PLASTIC_SLABS = EnumColorCollection.VALUES
          .map(color -> registerPlasticSlab(color, "_plastic_slab", UnaryOperator.identity()));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticFence, BlockItem>> PLASTIC_FENCES = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockPlasticFence::new, "_plastic_fence", color));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticFenceGate, BlockItem>> PLASTIC_FENCE_GATES = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockPlasticFenceGate::new, "_plastic_fence_gate", color));
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticStairs, BlockItem>> PLASTIC_GLOW_STAIRS = EnumColorCollection.zipMap(
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticSlab, BlockItem>> PLASTIC_GLOW_SLABS = EnumColorCollection.VALUES
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticTransparentStairs, BlockItem>> TRANSPARENT_PLASTIC_STAIRS = EnumColorCollection.zipMap(
    ...
    public static final EnumColorCollection<BlockRegistryObject<BlockPlasticTransparentSlab, BlockItem>> TRANSPARENT_PLASTIC_SLABS = EnumColorCollection.VALUES
          .map(color -> registerColoredBlock(BlockPlasticTransparentSlab::new, "_plastic_transparent_slab", color));

    private static BlockRegistryObject<BlockPlastic, BlockItem> registerPlastic(EnumColor color, String blockTypeSuffix,
    ...
    private static BlockRegistryObject<BlockPlasticSlab, BlockItem> registerPlasticSlab(EnumColor color, String blockTypeSuffix,
          UnaryOperator<BlockBehaviour.Properties> propertyModifier) {
        return registerColoredBlock((properties, c) -> new BlockPlasticSlab(propertyModifier.apply(properties), c), blockTypeSuffix, color);
    }

    private static BlockRegistryObject<BlockPlasticStairs, BlockItem> registerPlasticStairs(Holder<Block> baseBlock, EnumColor color, String blockTypeSuffix,
          UnaryOperator<BlockBehaviour.Properties> propertyModifier) {
    ...
    private static <BLOCK extends Block & IColoredBlock> BlockRegistryObject<BLOCK, BlockItem> registerColoredBlock(
          BiFunction<BlockBehaviour.Properties, EnumColor, BLOCK> blockCreator, String blockTypeSuffix, EnumColor color) {
        return BLOCKS.register(color.getRegistryPrefix() + blockTypeSuffix, properties -> blockCreator.apply(properties, color));
    }
}