...
public class AdditionsBlocks {
    ...
    //TODO - 26.2: Do we want to do something similar to vanilla's ColorCollection?
    ...
    static {
        for (EnumColor color : EnumUtils.COLORS) {
            ...
            BlockRegistryObject<BlockPlastic, ItemBlockMekanism<BlockPlastic>> plasticGlowBlockRO = registerPlastic(color, "_plastic_glow",
                  properties -> properties.strength(5, 6).lightLevel(state -> 10).emissiveRendering(ConstantPredicates.alwaysTrue()));
            ...
            PLASTIC_GLOW_STAIRS.put(color, registerPlasticStairs(plasticGlowBlockRO, color, "_plastic_glow_stairs", properties -> properties.lightLevel(_ -> 10).emissiveRendering(ConstantPredicates.alwaysTrue())));
            PLASTIC_GLOW_SLABS.put(color, registerPlasticSlab(color, "_plastic_glow_slab", properties -> properties.lightLevel(_ -> 10).emissiveRendering(ConstantPredicates.alwaysTrue())));
