...
public class AdditionsAliasMapping implements IAliasMapping {
    ...
    public <ITEM, FLUID, CHEMICAL> void addAliases(RVAliasHelper<ITEM, FLUID, CHEMICAL> rv) {
        ...
        rv.addItemAliases(AdditionsTags.BlockItems.GLOW_PANELS, AdditionsAliases.GLOW_PANEL_LIGHT_SOURCE);
        rv.addItemAliases(AdditionsTags.BlockItems.PLASTIC_BLOCKS_ROAD, AdditionsAliases.PLASTIC_ROAD_PATH);
    }
}