...
public class QIOGameTestHelper extends MekGameTestHelper {
    ...
    public void addDrives(QIOFrequency frequency) {
        ...
        //TODO - 26.3: Do we need to somehow set the frequency on the BE? Maybe for testing modifications to the drive slots
    ...
    public void testExtract(QIOFrequency frequency, ItemResource itemType, long amount, boolean commit) {
        //TODO - 26.3: Is there a better way for us to do this that ends up with having items in the frequency to be able to extract from?
