...
public class ModelFluidTank extends MekanismJavaModel {
    ...
    private static final RenderType GLASS_RENDER_TYPE = RenderType.entityCutout(TANK_TEXTURE);
    ...
    public ModelFluidTank() {
        ...
        FrontGlass.setPos(-5F, 9F, -6F);
        FrontGlass.setTexSize(128, 128);
        ...
        BackGlass.setPos(-5F, 9F, 2F);
        BackGlass.setTexSize(128, 128);
        ...
        RightGlass.setPos(-6F, 9F, -5F);
        RightGlass.setTexSize(128, 128);
        ...
        LeftGlass.setPos(5F, 9F, -5F);
        LeftGlass.setTexSize(128, 128);
