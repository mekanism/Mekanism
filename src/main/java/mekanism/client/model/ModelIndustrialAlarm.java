...
public class ModelIndustrialAlarm extends Model<IndustrialAlarmRenderState> {
    ...
    public void setupAnim(IndustrialAlarmRenderState state) {
        ...
        //TODO - 26.3: Validate that we can just rotate the root and have it work for both the bulb and the aura
    ...
    public static class IndustrialAlarmRenderState {
        ...
        public void setRotation(float rotation) {
            ...
            //TODO - 26.3: See if there is a helper in Mth to do this calculation with
