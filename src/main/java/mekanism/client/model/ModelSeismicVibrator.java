...
public class ModelSeismicVibrator extends Model {
    ...
    RendererModel baseBack;
    RendererModel motor;
    RendererModel port;
    RendererModel pole4;
    RendererModel shaft2;
    RendererModel shaft1;
    RendererModel arm3;
    RendererModel plate2;
    RendererModel arm2;
    RendererModel arm1;
    RendererModel top;
    RendererModel frameBack5;
    RendererModel pole3;
    RendererModel frameRight5;
    RendererModel baseRight;
    RendererModel baseFront;
    RendererModel baseLeft;
    RendererModel frameRight3;
    RendererModel pole1;
    RendererModel frameRight4;
    RendererModel frameRight1;
    RendererModel frameRight2;
    RendererModel frameLeft5;
    RendererModel frameLeft4;
    RendererModel frameBack3;
    RendererModel frameLeft2;
    RendererModel frameLeft1;
    RendererModel pole2;
    RendererModel frameBack1;
    RendererModel frameBack2;
    RendererModel frameBack4;
    RendererModel frameLeft3;
    RendererModel conduit;
    RendererModel plate1;
    RendererModel rivet10;
    RendererModel rivet5;
    RendererModel rivet1;
    RendererModel rivet6;
    RendererModel rivet2;
    RendererModel rivet7;
    RendererModel rivet3;
    RendererModel rivet8;
    RendererModel rivet4;
    RendererModel rivet9;
