...
public class ModelResistiveHeater extends Model {
    ...
    private final RenderType RENDER_TYPE = func_228282_a_(HEATER_TEXTURE);
    ...
    public void render(@Nonnull MatrixStack matrix, @Nonnull IRenderTypeBuffer renderer, int light, int overlayLight, boolean on) {
        ...
        func_225598_a_(matrix, renderer.getBuffer(on ? RENDER_TYPE_ON : RENDER_TYPE_OFF), MekanismRenderer.FULL_LIGHT, overlayLight, 1, 1, 1, 1);
    ...
    public void func_225598_a_(@Nonnull MatrixStack matrix, @Nonnull IVertexBuilder vertexBuilder, int light, int overlayLight, float red, float green, float blue,
          float alpha) {
        wallLeft.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        base.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        fin10.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        portRight.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        fin9.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        ...
        bar4.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        bar3.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        wallRight.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
