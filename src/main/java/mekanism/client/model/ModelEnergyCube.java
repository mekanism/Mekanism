...
public class ModelEnergyCube extends Model {
    ...
    public RendererModel[] connectors;
    ...
    RendererModel connectorBackToggle;
    RendererModel connectorRightToggle;
    RendererModel connectorBottomToggle;
    RendererModel connectorLeftToggle;
    RendererModel connectorFrontToggle;
    RendererModel connectorTopToggle;
    RendererModel portBackToggle;
    RendererModel portBottomToggle;
    RendererModel portFrontToggle;
    RendererModel portLeftToggle;
    RendererModel portRightToggle;
    RendererModel portTopToggle;
    RendererModel ledTop1;
    RendererModel ledTop2;
    RendererModel ledBack1;
    RendererModel ledBack2;
    RendererModel ledBottom2;
    RendererModel ledBottom1;
    RendererModel ledFront1;
    RendererModel ledFront2;
    RendererModel ledRight2;
    RendererModel ledRight1;
    RendererModel ledLeft1;
    RendererModel ledLeft2;
