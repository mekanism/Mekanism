...
public class ModelGasMask extends Model {
    ...
    RendererModel helmetfeed;
    RendererModel tubeback;
    RendererModel tubeL;
    RendererModel tubeR;
    RendererModel tubefront;
    RendererModel mouthintake;
    RendererModel finupperR;
    RendererModel finupperL;
    RendererModel finmidR;
    RendererModel finmidL;
    RendererModel finback;
    RendererModel topplate;
    RendererModel filterL;
    RendererModel filterR;
    RendererModel filterpipelower;
    RendererModel filterpipeupper;
    RendererModel glasstop;
    RendererModel glassfront;
    RendererModel glassR;
    RendererModel glassL;
    RendererModel glassbackR;
    RendererModel glassbackL;
    RendererModel pipecornerFL;
    RendererModel pipecornerFR;
    RendererModel pipecornerBR;
    RendererModel pipecornerBL;
    RendererModel lightL;
    RendererModel lightR;
