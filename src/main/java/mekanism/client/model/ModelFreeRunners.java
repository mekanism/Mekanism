...
public class ModelFreeRunners extends MekanismJavaModel {
    ...
    public ModelFreeRunners() {
        ...
        SupportR.setPos(0F, 0F, 0F);
        SupportR.setTexSize(64, 32);
