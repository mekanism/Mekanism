...
public class TieredParticleDigging extends ParticleDigging {
    ...
    public TieredParticleDigging(World world, double xCoord, double yCoord, double zCoord, double xSpeed,
          double ySpeed, double zSpeed, IBlockState state, EnumColor color) {
