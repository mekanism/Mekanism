...
public class FlameModel extends EntityModel<FlameRenderState> {
    ...
    public static LayerDefinition createLayerDefinition() {
        ...
        //TODO - 26.3: Is this the correct part of the arrow model we are copying
        CubeListBuilder cross = CubeListBuilder.create()
              .texOffs(0, 0)
              //TODO - 26.3: Figure out the tex scale's we want to be using as our flame particle goes further than vanilla's arrow
        ...
        //TODO - 26.3: I believe the normal might be different than it used to be?
        //builder.setNormal(matrix.last(), 0, 0, scale);
        //TODO - 26.3: What does this scale represent?
