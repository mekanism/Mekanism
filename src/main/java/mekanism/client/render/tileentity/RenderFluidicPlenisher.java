...
public class RenderFluidicPlenisher extends TileEntitySpecialRenderer<TileEntityFluidicPlenisher>
{
	private ModelFluidicPlenisher model = new ModelFluidicPlenisher();

	@Override
	public void renderTileEntityAt(TileEntityFluidicPlenisher tileEntity, double x, double y, double z, float partialTick, int destroyStage)
	{
