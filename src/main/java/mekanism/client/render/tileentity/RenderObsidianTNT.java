...
public class RenderObsidianTNT extends TileEntitySpecialRenderer<TileEntityObsidianTNT>
{
	private ModelObsidianTNT model = new ModelObsidianTNT();

	@Override
	public void renderTileEntityAt(TileEntityObsidianTNT tileEntity, double x, double y, double z, float partialTick, int destroyStage)
	{
		GL11.glPushMatrix();
