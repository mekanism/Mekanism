...
public class RenderPressurizedReactionChamber extends TileEntitySpecialRenderer<TileEntityPRC>
{
	private ModelPressurizedReactionChamber model = new ModelPressurizedReactionChamber();

	@Override
	public void renderTileEntityAt(TileEntityPRC tileEntity, double x, double y, double z, float partialTick, int destroyStage)
	{
		GL11.glPushMatrix();
