...
public class RenderElectrolyticSeparator extends TileEntitySpecialRenderer<TileEntityElectrolyticSeparator>
{
	private ModelElectrolyticSeparator model = new ModelElectrolyticSeparator();

	@Override
	public void renderTileEntityAt(TileEntityElectrolyticSeparator tileEntity, double x, double y, double z, float partialTick, int destroyStage)
	{
		GL11.glPushMatrix();
