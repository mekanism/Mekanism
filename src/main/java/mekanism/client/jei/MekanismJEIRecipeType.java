...
public record MekanismJEIRecipeType<RECIPE>(ResourceLocation uid, Class<? extends RECIPE> recipeClass, boolean requiresHolder) {
    ...
    public static final MekanismJEIRecipeType<CraftingRecipe> VANILLA_CRAFTING = new MekanismJEIRecipeType<>(new ResourceLocation("crafting"), CraftingRecipe.class, true);
    ...
    public static final MekanismJEIRecipeType<ItemStackToEnergyRecipe> ENERGY_CONVERSION = new MekanismJEIRecipeType<>(MekanismRecipeType.ENERGY_CONVERSION, ItemStackToEnergyRecipe.class);

    public static final MekanismJEIRecipeType<ItemStackToGasRecipe> GAS_CONVERSION = new MekanismJEIRecipeType<>(MekanismRecipeType.GAS_CONVERSION, ItemStackToGasRecipe.class);
    ...
    public static final MekanismJEIRecipeType<ItemStackToInfuseTypeRecipe> INFUSION_CONVERSION = new MekanismJEIRecipeType<>(MekanismRecipeType.INFUSION_CONVERSION, ItemStackToInfuseTypeRecipe.class);
    ...
    public static final MekanismJEIRecipeType<RotaryRecipe> CONDENSENTRATING = new MekanismJEIRecipeType<>(Mekanism.rl("condensentrating"), RotaryRecipe.class, false);
    public static final MekanismJEIRecipeType<RotaryRecipe> DECONDENSENTRATING = new MekanismJEIRecipeType<>(Mekanism.rl("decondensentrating"), RotaryRecipe.class, false);
    ...
    public static final MekanismJEIRecipeType<BoilerJEIRecipe> BOILER = new MekanismJEIRecipeType<>(MekanismBlocks.BOILER_CASING, BoilerJEIRecipe.class, false);
    public static final MekanismJEIRecipeType<SPSJEIRecipe> SPS = new MekanismJEIRecipeType<>(MekanismBlocks.SPS_CASING, SPSJEIRecipe.class, false);

    public static final MekanismJEIRecipeType<ItemStackToFluidRecipe> NUTRITIONAL_LIQUIFICATION = new MekanismJEIRecipeType<>(MekanismBlocks.NUTRITIONAL_LIQUIFIER, ItemStackToFluidRecipe.class, false);

    public MekanismJEIRecipeType(INamedEntry namedEntry, Class<? extends RECIPE> recipeClass) {
        this(namedEntry, recipeClass, true);
    }

    public MekanismJEIRecipeType(INamedEntry namedEntry, Class<? extends RECIPE> recipeClass, boolean requiresHolder) {
        this(namedEntry.getId(), recipeClass, requiresHolder);
    }
