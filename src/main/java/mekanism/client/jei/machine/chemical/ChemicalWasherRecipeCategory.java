...
public class ChemicalWasherRecipeCategory extends BaseRecipeCategory {
    ...
    public ChemicalWasherRecipeCategory(IGuiHelper helper) {
        super(helper, "mekanism:gui/nei/GuiChemicalWasher.png", Recipe.CHEMICAL_WASHER.jeiRecipeUid,
    ...
    public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients) {
        ...
        fluidStacks.addTooltipCallback((index, input, ingredient, tooltip) -> tooltip
              .set(1, LangUtils.localizeWithFormat("mekanism.jei.amount.per.tick", tooltip.get(1))));
