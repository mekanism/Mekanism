...
public class ChemicalWasherRecipeCategory extends BaseRecipeCategory<ChemicalWasherRecipeWrapper> {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, ChemicalWasherRecipeWrapper recipeWrapper, IIngredients ingredients) {
        ChemicalWasherRecipe tempRecipe = recipeWrapper.getRecipe();
        IGuiFluidStackGroup fluidStacks = recipeLayout.getFluidStacks();
        @NonNull List<FluidStack> fluidInputs = tempRecipe.getCleansingIngredient().getRepresentations();
