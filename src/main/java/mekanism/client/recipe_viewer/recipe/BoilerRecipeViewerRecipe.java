...
public record BoilerRecipeViewerRecipe(@Nullable GasStackIngredient superHeatedCoolant, FluidStackIngredient water, GasStack steam, GasStack cooledCoolant,
    ...
    public static Map<ResourceLocation, BoilerRecipeViewerRecipe> getBoilerRecipes() {
        ...
        Map<ResourceLocation, BoilerRecipeViewerRecipe> recipes = new LinkedHashMap<>();
        ...
        recipes.put(Mekanism.rl("generated_boiler/water"), new BoilerRecipeViewerRecipe(null, IngredientCreatorAccess.fluid().from(FluidTags.WATER, waterAmount),
        ...
        for (Gas gas : MekanismAPI.GAS_REGISTRY) {
            gas.ifAttributePresent(HeatedCoolant.class, heatedCoolant -> {
                ...
                recipes.put(Mekanism.rl("generated_boiler/" + gas.getRegistryName().toString().replace(':', '_')),
