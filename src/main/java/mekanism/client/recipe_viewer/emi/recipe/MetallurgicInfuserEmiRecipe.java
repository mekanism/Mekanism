...
public class MetallurgicInfuserEmiRecipe extends MekanismEmiHolderRecipe<MetallurgicInfuserRecipe> {

    public MetallurgicInfuserEmiRecipe(MekanismEmiRecipeCategory category, RecipeHolder<MetallurgicInfuserRecipe> recipeHolder) {
