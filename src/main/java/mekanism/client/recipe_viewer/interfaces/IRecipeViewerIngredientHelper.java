...
public interface IRecipeViewerIngredientHelper {
    ...
    ///
    /// @return Ingredient or [Optional#empty()].
    ///
    /// @apiNote isMouseOver is called before this method, the positions are mainly provided for use by things like [mekanism.client.gui.element.scroll.GuiSlotScroll]
    /// that may have different ingredients based on where in the element the mouse is.
