...
public class GuiDigitalSwitch extends GuiTexturedElement {
    ...
    public void renderForeground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        ...
        drawScaledScrollingString(guiGraphics, MekanismLang.ON.translate(), type.switchX, type.switchY, TextAlignment.CENTER, 0xFF101010, BUTTON_SIZE_X, 1, false, 0.5F);
        drawScaledScrollingString(guiGraphics, MekanismLang.OFF.translate(), type.switchX, type.switchY + BUTTON_SIZE_Y + 1, TextAlignment.CENTER, 0xFF101010, BUTTON_SIZE_X, 1, false, 0.5F);
    }
