...
public enum ButtonType {
    NORMAL((field, callback) -> new MekanismImageButton(field.gui(), field.getGuiLeft() + field.getRelativeX() + field.getWidth() - field.getHeight(),
          field.getGuiTop() + field.getRelativeY(), field.getHeight(), 12,
          MekanismUtils.getResource(ResourceType.GUI_BUTTON, "checkmark.png"), callback)),
    DIGITAL((field, callback) -> {
        MekanismImageButton ret = new MekanismImageButton(field.gui(), field.getGuiLeft() + field.getRelativeX() + field.getWidth() - field.getHeight(),
              field.getGuiTop() + field.getRelativeY(), field.getHeight(), 12,
