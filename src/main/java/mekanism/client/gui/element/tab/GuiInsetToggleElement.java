...
public abstract class GuiInsetToggleElement<DATA_SOURCE> extends GuiInsetElement<DATA_SOURCE> {
    ...
    public GuiInsetToggleElement(IGuiWrapper gui, DATA_SOURCE dataSource, int x, int y, int height, int innerSize, boolean left, Identifier overlay,
          Identifier flipped, Predicate<DATA_SOURCE> isToggled) {
        this(gui, dataSource, x, y, height, innerSize, left, overlay, flipped, () -> isToggled.test(dataSource));
    }

    public GuiInsetToggleElement(IGuiWrapper gui, DATA_SOURCE dataSource, int x, int y, int height, int innerSize, boolean left, Identifier overlay,
          Identifier flipped, BooleanSupplier isToggled) {
