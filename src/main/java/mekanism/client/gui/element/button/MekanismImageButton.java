...
public class MekanismImageButton extends MekanismButton {
    ...
    public MekanismImageButton(IGuiWrapper gui, int x, int y, int size, ResourceLocation resource, @NotNull Runnable onLeftClick, @NotNull Runnable onRightClick,
    ...
    public MekanismImageButton(IGuiWrapper gui, int x, int y, int size, int textureSize, ResourceLocation resource, @NotNull Runnable onLeftClick,
          @NotNull Runnable onRightClick, @Nullable IHoverable onHover) {
    ...
    public MekanismImageButton(IGuiWrapper gui, int x, int y, int width, int height, int textureWidth, int textureHeight, ResourceLocation resource,
          @NotNull Runnable onLeftClick, @NotNull Runnable onRightClick, @Nullable IHoverable onHover) {
