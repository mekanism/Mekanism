...
public class GuiButtonImageMek extends GuiButton {
    ...
    public GuiButtonImageMek(int id, int x, int y, int width, int height, int offsetX, int offsetY, int hoverOffset, ResourceLocation resource) {
        this(id, x, y, width, height, offsetX, offsetY, hoverOffset, 0, resource);
    }

    public GuiButtonImageMek(int id, int x, int y, int width, int height, int offsetX, int offsetY, int hoverOffset, int disabledOffset, ResourceLocation resource) {
