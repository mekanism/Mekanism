...
public class GuiRobitMain extends GuiMekanism<MainRobitContainer> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 27, 16, 122, 56, () -> List.of(
              ...
              MekanismLang.ENERGY.translate(EnergyDisplay.of(robit.getEnergyContainer().getAmountAsLong())),
        ...
        addRenderableWidget(new MekanismImageButton(this, 6, 16, 18, Mekanism.rl("button/home"), (element, _, _) -> {
        ...
        renameButton = addRenderableWidget(new MekanismImageButton(this, 6, 35, 18, Mekanism.rl("button/rename"), (element, _, _) -> {
        ...
        skinButton = addRenderableWidget(new MekanismImageButton(this, 6, 54, 18, Mekanism.rl("button/skin"), (element, _, _) -> {
            GuiRobitMain gui = (GuiRobitMain) element.gui();
            gui.openWindow(new GuiRobitSkinSelect(gui, 4, -12, gui.robit), () -> skinButton);
            return true;
        })).setTooltip(MekanismLang.ROBIT_SKIN_SELECT);
        addRenderableWidget(new MekanismImageButton(this, 152, 35, 18, Mekanism.rl("button/drop"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityGuiInteract(GuiInteractionEntity.PICKUP_DROPS, ((GuiRobitMain) element.gui()).robit))))
              .setTooltip(MekanismLang.ROBIT_TOGGLE_PICKUP);
        addRenderableWidget(new MekanismImageButton(this, 152, 54, 18, Mekanism.rl("button/follow"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityGuiInteract(GuiInteractionEntity.FOLLOW, ((GuiRobitMain) element.gui()).robit))))
              .setTooltip(MekanismLang.ROBIT_TOGGLE_FOLLOW);
        addRenderableWidget(new MekanismImageButton(this, imageWidth + 3, 10, 18, Mekanism.rl("button/main"), (_, _, _) -> {
            //Clicking main button doesn't do anything while already on the main GUI
            return true;
        })).setTooltip(ROBIT);
        addRenderableWidget(new MekanismImageButton(this, imageWidth + 3, 30, 18, Mekanism.rl("button/crafting"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityButtonPress(ClickedEntityButton.ROBIT_CRAFTING, ((GuiRobitMain) element.gui()).robit))))
              .setTooltip(ROBIT_CRAFTING);
        addRenderableWidget(new MekanismImageButton(this, imageWidth + 3, 50, 18, Mekanism.rl("button/inventory"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityButtonPress(ClickedEntityButton.ROBIT_INVENTORY, ((GuiRobitMain) element.gui()).robit))))
              .setTooltip(ROBIT_INVENTORY);
        addRenderableWidget(new MekanismImageButton(this, imageWidth + 3, 70, 18, Mekanism.rl("button/smelting"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityButtonPress(ClickedEntityButton.ROBIT_SMELTING, ((GuiRobitMain) element.gui()).robit))))
              .setTooltip(ROBIT_SMELTING);
        addRenderableWidget(new MekanismImageButton(this, imageWidth + 3, 90, 18, Mekanism.rl("button/repair"),
              (element, _, _) -> PacketUtils.sendToServer(new PacketEntityButtonPress(ClickedEntityButton.ROBIT_REPAIR, ((GuiRobitMain) element.gui()).robit))))
