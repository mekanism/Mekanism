...
public class GuiCombiner extends GuiMekanismTile<TileEntityCombiner> {

    public GuiCombiner(InventoryPlayer inventory, TileEntityCombiner tile) {
        super(tile, new ContainerCombiner(inventory, tile));
