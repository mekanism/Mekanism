...
public class GuiCredits extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick) {
        ...
        for (IModule module : Mekanism.modulesLoaded) {
            ...
            if (Mekanism.latestVersionNumber != null && !Mekanism.latestVersionNumber.equals("null")) {
                writeText(EnumColor.INDIGO + "Mekanism" + module.getName() + (
                      module.getVersion().comparedState(Version.get(Mekanism.latestVersionNumber)) == -1
                            ? EnumColor.DARK_RED : EnumColor.GREY) + " " + module.getVersion(), size);
            } else {
                writeText(EnumColor.INDIGO + "Mekanism" + module.getName() + EnumColor.GREY + " " + module.getVersion(),
                      size);
            }
        }
        ...
        writeText(EnumColor.GREY + "Recent news: " + EnumColor.DARK_BLUE + (!Mekanism.recentNews.contains("null")
              ? Mekanism.recentNews : "couldn't access."), size + 36);
