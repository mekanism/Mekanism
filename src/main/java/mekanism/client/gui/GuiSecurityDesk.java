...
public class GuiSecurityDesk extends GuiMekanism
{
	...
	public void mouseClicked(int mouseX, int mouseY, int button) throws IOException
	{
		...
		if(button == 0)
		{
			...
			if(tileEntity.frequency != null && tileEntity.ownerUUID != null && tileEntity.clientOwner.equals(mc.thePlayer.getName()))
			{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		if(tileEntity.frequency != null && tileEntity.clientOwner != null && mc.thePlayer.getName().equals(tileEntity.clientOwner))
		{
