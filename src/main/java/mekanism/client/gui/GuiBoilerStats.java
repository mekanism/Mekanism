...
public class GuiBoilerStats extends GuiMekanismTile<TileEntityBoilerCasing, EmptyTileContainer<TileEntityBoilerCasing>> {
    ...
    public void init() {
        ...
        maxGraph.enableFixedScale((int) ((MekanismConfig.general.superheatingHeatTransfer.get() * tile.getSuperheatingElements()) / HeatUtils.getVaporizationEnthalpy()));
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        int boilCapacity = (int) ((MekanismConfig.general.superheatingHeatTransfer.get() * tile.getSuperheatingElements()) / HeatUtils.getVaporizationEnthalpy());
