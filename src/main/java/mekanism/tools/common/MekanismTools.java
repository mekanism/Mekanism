...
@Mod(modid = "mekanismtools", name = "MekanismTools", version = "9.4.0", dependencies = "required-after:mekanism", guiFactory = "mekanism.tools.client.gui.ToolsGuiFactory", acceptedMinecraftVersions = "[1.12,1.13)")
