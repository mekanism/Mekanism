...
public class ItemMekanismPickaxe extends ItemMekanismTool {
    ...
    private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(
          new Block[]{Blocks.ACTIVATOR_RAIL, Blocks.COAL_ORE, Blocks.COBBLESTONE, Blocks.DETECTOR_RAIL,
    ...
    public float getStrVsBlock(ItemStack itemstack, IBlockState blockState) {
        if (blockState != null && blockState.getBlock() != null && (blockState.getMaterial() == Material.IRON
