...
public class MekanismLootFunctions {
    ...
    public static final MekanismDeferredHolder<LootItemFunctionType, LootItemFunctionType> COPY_TO_ATTACHMENTS = REGISTER.registerCodec("copy_attachments", () -> CopyToAttachmentsLootFunction.CODEC);
