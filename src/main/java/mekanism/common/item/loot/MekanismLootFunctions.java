...
public class MekanismLootFunctions {
    ...
    public static final MekanismDeferredHolder<LootItemFunctionType<?>, LootItemFunctionType<CopyContainersLootFunction>> COPY_CONTAINERS = REGISTER.registerCodec("copy_containers", () -> CopyContainersLootFunction.CODEC);
