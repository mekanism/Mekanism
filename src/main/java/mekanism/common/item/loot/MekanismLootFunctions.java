...
public class MekanismLootFunctions {
    ...
    public static final RegistryObject<LootItemFunctionType> PERSONAL_STORAGE_LOOT_FUNC = REGISTER.register("personal_storage_contents", ()->new LootItemFunctionType(new PersonalStorageContentsLootFunction.Serialiser()));
}
