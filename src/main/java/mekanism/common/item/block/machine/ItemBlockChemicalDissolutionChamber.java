...
public class ItemBlockChemicalDissolutionChamber extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityChemicalDissolutionChamber tile = (TileEntityChemicalDissolutionChamber) world.getTileEntity(pos);
            //Security
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockChemicalDissolutionChamber) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockChemicalDissolutionChamber) (((ItemBlockChemicalDissolutionChamber) item).block)).getStorage());
        }
        return 0;
    }
