...
public class ItemBlockElectricPump extends ItemBlockAdvancedTooltip<BlockElectricPump> implements IItemEnergized, IItemSustainedInventory, IItemSustainedTank,
      ISecurityItem {
