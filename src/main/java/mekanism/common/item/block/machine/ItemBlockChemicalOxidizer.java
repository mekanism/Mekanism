...
public class ItemBlockChemicalOxidizer extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityChemicalOxidizer tile = (TileEntityChemicalOxidizer) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockChemicalOxidizer) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockChemicalOxidizer) (((ItemBlockChemicalOxidizer) item).block)).getStorage());
        }
        return 0;
    }
