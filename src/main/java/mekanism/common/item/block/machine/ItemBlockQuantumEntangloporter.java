...
public class ItemBlockQuantumEntangloporter extends ItemBlockAdvancedTooltip<BlockMachine<?, ?>> implements IItemEnergized, IItemSustainedInventory, ISecurityItem {

    public ItemBlockQuantumEntangloporter(BlockMachine<?, ?> block) {
