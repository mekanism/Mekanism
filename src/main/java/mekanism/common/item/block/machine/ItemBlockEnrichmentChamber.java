...
public class ItemBlockEnrichmentChamber extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityEnrichmentChamber tile = (TileEntityEnrichmentChamber) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockEnrichmentChamber) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockEnrichmentChamber) (((ItemBlockEnrichmentChamber) item).block)).getStorage());
        }
        return 0;
    }
