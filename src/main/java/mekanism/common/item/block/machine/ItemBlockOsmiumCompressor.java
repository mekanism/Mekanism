...
public class ItemBlockOsmiumCompressor extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityOsmiumCompressor tile = (TileEntityOsmiumCompressor) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockOsmiumCompressor) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockOsmiumCompressor) (((ItemBlockOsmiumCompressor) item).block)).getStorage());
        }
        return 0;
    }
