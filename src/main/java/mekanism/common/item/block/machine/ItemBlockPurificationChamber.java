...
public class ItemBlockPurificationChamber extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityPurificationChamber tile = (TileEntityPurificationChamber) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockPurificationChamber) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockPurificationChamber) (((ItemBlockPurificationChamber) item).block)).getStorage());
        }
        return 0;
    }
