...
public class ItemBlockMetallurgicInfuser extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockMetallurgicInfuser) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockMetallurgicInfuser) (((ItemBlockMetallurgicInfuser) item).block)).getStorage());
        }
        return 0;
    }
