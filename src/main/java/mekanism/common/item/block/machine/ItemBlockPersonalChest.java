...
public class ItemBlockPersonalChest extends ItemBlockAdvancedTooltip<BlockMachineModel<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockPersonalChest(BlockMachineModel<?, ?> block) {
