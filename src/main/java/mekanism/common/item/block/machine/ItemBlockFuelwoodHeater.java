...
public class ItemBlockFuelwoodHeater extends ItemBlockAdvancedTooltip<BlockMachine<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockFuelwoodHeater(BlockMachine<?, ?> block) {
