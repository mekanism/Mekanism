...
public class ItemBlockFuelwoodHeater extends ItemBlockAdvancedTooltip<BlockBase<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockFuelwoodHeater(BlockBase<?, ?> block) {
