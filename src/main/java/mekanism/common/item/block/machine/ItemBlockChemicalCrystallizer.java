...
public class ItemBlockChemicalCrystallizer extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityChemicalCrystallizer tile = (TileEntityChemicalCrystallizer) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockChemicalCrystallizer) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockChemicalCrystallizer) (((ItemBlockChemicalCrystallizer) item).block)).getStorage());
        }
        return 0;
    }
