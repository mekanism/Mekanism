...
public class ItemBlockLaserAmplifier extends ItemBlockAdvancedTooltip<BlockBase<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockLaserAmplifier(BlockBase<?, ?> block) {
