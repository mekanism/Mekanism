...
public class ItemBlockLaserTractorBeam extends ItemBlockAdvancedTooltip<BlockBase<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockLaserTractorBeam(BlockBase<?, ?> block) {
