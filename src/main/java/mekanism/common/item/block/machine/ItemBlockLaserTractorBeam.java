...
public class ItemBlockLaserTractorBeam extends ItemBlockAdvancedTooltip<BlockMachine<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockLaserTractorBeam(BlockMachine<?, ?> block) {
