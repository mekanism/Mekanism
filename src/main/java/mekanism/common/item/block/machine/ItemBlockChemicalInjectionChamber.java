...
public class ItemBlockChemicalInjectionChamber extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (super.placeBlockAt(stack, player, world, pos, side, hitX, hitY, hitZ, state)) {
            TileEntityChemicalInjectionChamber tile = (TileEntityChemicalInjectionChamber) world.getTileEntity(pos);
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockChemicalInjectionChamber) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockChemicalInjectionChamber) (((ItemBlockChemicalInjectionChamber) item).block)).getStorage());
        }
        return 0;
    }
