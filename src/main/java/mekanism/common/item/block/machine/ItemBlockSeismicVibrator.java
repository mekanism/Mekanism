...
public class ItemBlockSeismicVibrator extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockSeismicVibrator) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockSeismicVibrator) (((ItemBlockSeismicVibrator) item).block)).getStorage());
        }
        return 0;
    }
