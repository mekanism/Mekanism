...
public class ItemBlockOredictionificator extends ItemBlockAdvancedTooltip<BlockBase<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockOredictionificator(BlockBase<?, ?> block) {
