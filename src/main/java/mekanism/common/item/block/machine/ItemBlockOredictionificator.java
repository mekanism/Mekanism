...
public class ItemBlockOredictionificator extends ItemBlockAdvancedTooltip<BlockMachine<?, ?>> implements IItemSustainedInventory, ISecurityItem {

    public ItemBlockOredictionificator(BlockMachine<?, ?> block) {
