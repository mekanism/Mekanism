...
public class ItemBlockPrecisionSawmill extends ItemBlockMekanism implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem, ISecurityItem {
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlockPrecisionSawmill) {
            return MekanismUtils.getMaxEnergy(itemStack, ((BlockPrecisionSawmill) (((ItemBlockPrecisionSawmill) item).block)).getStorage());
        }
        return 0;
    }
