...
public final class BlockShapes {
    ...
    private static final int DIRECTIONS = EnumUtils.DIRECTIONS.length;
    private static final int HORIZONTAL_DIRECTIONS = EnumUtils.HORIZONTAL_DIRECTIONS.length;
    public static final VoxelShape[] ELECTROLYTIC_SEPARATOR = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] DIGITAL_MINER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_CRYSTALLIZER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] PRESSURIZED_REACTION_CHAMBER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] METALLURGIC_INFUSER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_WASHER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_OXIDIZER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_INFUSER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_DISSOLUTION_CHAMBER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] ROTARY_CONDENSENTRATOR = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] FLUIDIC_PLENISHER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] ELECTRIC_PUMP = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] SOLAR_NEUTRON_ACTIVATOR = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHARGEPAD = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] FLUID_TANK = {box(2, 0, 2, 14, 16, 14)};
    public static final VoxelShape[] LASER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] LASER_AMPLIFIER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] RESISTIVE_HEATER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] SEISMIC_VIBRATOR = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] PERSONAL_CHEST = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] QUANTUM_ENTANGLOPORTER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] LOGISTICAL_SORTER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] SECURITY_DESK = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CHEMICAL_TANK = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] INDUSTRIAL_ALARM = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] QIO_DASHBOARD = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] QIO_DRIVE_ARRAY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] QIO_IMPORTER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] QIO_EXPORTER = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] QIO_REDSTONE_ADAPTER = new VoxelShape[DIRECTIONS];
    ...
    public static final VoxelShape[] MODIFICATION_STATION = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] ISOTOPIC_CENTRIFUGE = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] SUPERCHARGED_COIL = new VoxelShape[DIRECTIONS];
    public static final VoxelShape[] ANTIPROTONIC_NUCLEOSYNTHESIZER = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] PIGMENT_MIXER = new VoxelShape[HORIZONTAL_DIRECTIONS];

    //Factories
    public static final VoxelShape[] SMELTING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] ENRICHING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] CRUSHING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] COMPRESSING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] COMBINING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] PURIFYING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] INJECTING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] INFUSING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
    public static final VoxelShape[] SAWING_FACTORY = new VoxelShape[HORIZONTAL_DIRECTIONS];
