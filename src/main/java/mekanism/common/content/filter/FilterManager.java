...
public class FilterManager<FILTER extends IFilter<?>> {
    ...
    //TODO - 26.3: Test this and deserialization
    ...
    public void deserialize(ValueInput input) {
        ...
        // we can also add them to the enabled ones, and also overwrite our old cache
        enabledFilters = new ArrayList<>();
        //TODO - 26.3: Validate this behaves appropriately with partial loading. We might have to treat it as a child list and deserialize one element at a time
