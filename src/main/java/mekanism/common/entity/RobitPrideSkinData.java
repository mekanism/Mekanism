...
public enum RobitPrideSkinData {
    ...
    TRANS(0xFF5BCEFA, 0xFFF5A9B8, CommonColors.WHITE, 0xFFF5A9B8),
    ARO(0xFF3DA745, 0xFFA7D37A, CommonColors.WHITE, 0xFFABABAB, CommonColors.BLACK),
    ACE(CommonColors.BLACK, 0xFFABABAB, CommonColors.WHITE, 0xFF7E287F),
    BI(0xFFD51673, 0xFFD51673, 0xFF9B4F97, 0xFF1E419B, 0xFF1E419B),
    ENBY(0xFFF7EE37, CommonColors.WHITE, 0xFF8A5FA7, CommonColors.BLACK),
