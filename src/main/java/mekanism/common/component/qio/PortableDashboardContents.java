...
// and then if we do decide to make it so that the dashboard can hold long amount of items (and natively handle referencing empty stacks), then it will natively support it
public record PortableDashboardContents(List<LargeResourceStack<ItemResource>> contents) {
