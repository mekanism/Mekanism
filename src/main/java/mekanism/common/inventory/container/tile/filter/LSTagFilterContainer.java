...
public class LSTagFilterContainer extends FilterContainer<TileEntityLogisticalSorter> {

    public LSTagFilterContainer(int id, PlayerInventory inv, TileEntityLogisticalSorter tile) {
