...
public class LSItemStackFilterContainer extends FilterContainer<TileEntityLogisticalSorter> {

    public LSItemStackFilterContainer(int id, PlayerInventory inv, TileEntityLogisticalSorter tile) {
