...
public class ContainerGirdlerSulfidProcessorController extends Container
{
	private TileEntityGirdlerSulfidProcessorController tileEntity;

	public ContainerGirdlerSulfidProcessorController(InventoryPlayer inventory, TileEntityGirdlerSulfidProcessorController tentity)
	{
		tileEntity = tentity;
