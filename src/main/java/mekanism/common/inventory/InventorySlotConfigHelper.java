...
//TODO: Would having this have a "wrapper" for the IInventorySlot or maybe at least have the miner have some sort of logic like that so that it "gives" different slot
// abilities based on the side it is on
public class InventorySlotConfigHelper implements IInventorySlotHolder {
    ...
    private InventorySlotConfigHelper(Supplier<Direction> facingSupplier) {
    ...
    public static class Builder {
        ...
        private final InventorySlotConfigHelper helper;
        private boolean built;

        private Builder(Supplier<Direction> facingSupplier) {
            helper = new InventorySlotConfigHelper(facingSupplier);
        }
        ...
        public InventorySlotConfigHelper build() {
            built = true;
            return helper;
        }
    }
