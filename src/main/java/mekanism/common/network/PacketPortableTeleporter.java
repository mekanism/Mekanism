                    ...
                    switch (message.packetType) {
                        ...
                        case TELEPORT:
                            ...
                            if (coords != null) {
                                ...
                                TileEntityTeleporter teleporter = (TileEntityTeleporter) coords
                                      .getTileEntity(teleWorld);
                                ...
                                if (teleporter != null) {
                                    try {
                                        ...
                                        item.setEnergy(itemstack,
                                              item.getEnergy(itemstack) - ItemPortableTeleporter
