...
public final class EnergyUtils {
    ...
    public static IEnergyContainer getEnergyContainer(@Nullable EnergyHandler handler) {
        ...
        //TODO - 26.3: Do we want a way to wrap energy handlers into an energy container for purposes of things like extractManual?
        //TODO - 26.3: We might want to change how we expose item caps in general so that they go via manual by default. Is there any reason we wouldn't want to?
