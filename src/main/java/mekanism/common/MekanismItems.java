...
public class MekanismItems
{
	...
	public static final ItemEnergizedTiered EnergyTablet = (ItemEnergizedTiered)new ItemEnergizedTiered(Tier.EquipmentTier.ADVANCED).setUnlocalizedName("EnergyTablet");
