...
public class TileEntityDynamicValve extends TileEntityDynamicTank implements IFluidHandlerWrapper {
    ...
    public boolean canFill(EnumFacing from, FluidStack fluid) {
        return ((!world.isRemote && structure != null) || (world.isRemote && clientHasStructure)) && fluid != null && (
              structure.fluidStored == null || fluid.isFluidEqual(structure.fluidStored));
    }

    @Override
    public boolean canDrain(EnumFacing from, @Nullable FluidStack fluid) {
        return ((!world.isRemote && structure != null) || (world.isRemote && clientHasStructure)) && (
              structure.fluidStored != null && structure.fluidStored.amount > 0) && (fluid == null || fluid
              .isFluidEqual(structure.fluidStored));
    }
