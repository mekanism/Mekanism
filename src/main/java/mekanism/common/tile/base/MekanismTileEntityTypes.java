...
public class MekanismTileEntityTypes {
    ...
    //Factories
    //Combining
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_COMBINING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_COMBINING_FACTORY, () -> new TileEntityCombiningFactory(MekanismBlock.BASIC_COMBINING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_COMBINING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_COMBINING_FACTORY, () -> new TileEntityCombiningFactory(MekanismBlock.ADVANCED_COMBINING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_COMBINING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_COMBINING_FACTORY, () -> new TileEntityCombiningFactory(MekanismBlock.ELITE_COMBINING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_COMBINING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_COMBINING_FACTORY, () -> new TileEntityCombiningFactory(MekanismBlock.ULTIMATE_COMBINING_FACTORY));
    //Compressing
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_COMPRESSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_COMPRESSING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.BASIC_COMPRESSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_COMPRESSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_COMPRESSING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ADVANCED_COMPRESSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_COMPRESSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_COMPRESSING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ELITE_COMPRESSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_COMPRESSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_COMPRESSING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ULTIMATE_COMPRESSING_FACTORY));
    //Crushing
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_CRUSHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_CRUSHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.BASIC_CRUSHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_CRUSHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_CRUSHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ADVANCED_CRUSHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_CRUSHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_CRUSHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ELITE_CRUSHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_CRUSHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_CRUSHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ULTIMATE_CRUSHING_FACTORY));
    //Enriching
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_ENRICHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_ENRICHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.BASIC_ENRICHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_ENRICHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_ENRICHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ADVANCED_ENRICHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_ENRICHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_ENRICHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ELITE_ENRICHING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_ENRICHING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_ENRICHING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ULTIMATE_ENRICHING_FACTORY));
    //Infusing
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_INFUSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_INFUSING_FACTORY, () -> new TileEntityMetallurgicInfuserFactory(MekanismBlock.BASIC_INFUSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_INFUSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_INFUSING_FACTORY, () -> new TileEntityMetallurgicInfuserFactory(MekanismBlock.ADVANCED_INFUSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_INFUSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_INFUSING_FACTORY, () -> new TileEntityMetallurgicInfuserFactory(MekanismBlock.ELITE_INFUSING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_INFUSING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_INFUSING_FACTORY, () -> new TileEntityMetallurgicInfuserFactory(MekanismBlock.ULTIMATE_INFUSING_FACTORY));
    //Injecting
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_INJECTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_INJECTING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.BASIC_INJECTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_INJECTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_INJECTING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ADVANCED_INJECTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_INJECTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_INJECTING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ELITE_INJECTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_INJECTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_INJECTING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ULTIMATE_INJECTING_FACTORY));
    //Purifying
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_PURIFYING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_PURIFYING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.BASIC_PURIFYING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_PURIFYING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_PURIFYING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ADVANCED_PURIFYING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_PURIFYING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_PURIFYING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ELITE_PURIFYING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_PURIFYING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_PURIFYING_FACTORY, () -> new TileEntityItemStackGasToItemStackFactory(MekanismBlock.ULTIMATE_PURIFYING_FACTORY));
    //Sawing
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_SAWING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_SAWING_FACTORY, () -> new TileEntitySawingFactory(MekanismBlock.BASIC_SAWING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_SAWING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_SAWING_FACTORY, () -> new TileEntitySawingFactory(MekanismBlock.ADVANCED_SAWING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_SAWING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_SAWING_FACTORY, () -> new TileEntitySawingFactory(MekanismBlock.ELITE_SAWING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_SAWING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_SAWING_FACTORY, () -> new TileEntitySawingFactory(MekanismBlock.ULTIMATE_SAWING_FACTORY));
    //Smelting
    public static final TileEntityTypeRegistryObject<TileEntityFactory> BASIC_SMELTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.BASIC_SMELTING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.BASIC_SMELTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ADVANCED_SMELTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ADVANCED_SMELTING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ADVANCED_SMELTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ELITE_SMELTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ELITE_SMELTING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ELITE_SMELTING_FACTORY));
    public static final TileEntityTypeRegistryObject<TileEntityFactory> ULTIMATE_SMELTING_FACTORY = TILE_ENTITY_TYPES.register(MekanismBlock.ULTIMATE_SMELTING_FACTORY, () -> new TileEntityItemStackToItemStackFactory(MekanismBlock.ULTIMATE_SMELTING_FACTORY));
}