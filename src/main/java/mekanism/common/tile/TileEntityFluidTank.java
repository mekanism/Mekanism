...
public class TileEntityFluidTank extends TileEntityMekanism implements IConfigurable, IFluidContainerManager {
    ...
    protected IContainerHolder<IFluidTank> getInitialFluidTanks(IContentsListener listener) {
        ...
        //TODO - 26.3: Should we add it as relative side top or Direction.UP? We used to use direction up, and this is technically the same
    ...
    public void writeReducedUpdatedTag(ValueOutput output) {
        ...
        //TODO - 26.3: Re-evaluate this alternate encoding further (check history)
    ...
    public void handleUpdateTag(ValueInput input) {
        ...
        //TODO - 26.3: Should we only update this when the scale has changed? And/or if we had updated the light level?
        prevScale = scale;
