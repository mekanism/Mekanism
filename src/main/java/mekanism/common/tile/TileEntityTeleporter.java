...
public class TileEntityTeleporter extends TileEntityMultiblock<TeleporterMultiblockData> implements IChunkLoader {
    ...
    protected void onUpdateServer() {
        ...
        TeleporterMultiblockData multiblock = getMultiblock();
        if (teleDelay == 0 && multiblock.isFormed() && !didTeleport.isEmpty()) {
            cleanTeleportCache();
        }
    ...
    private void cleanTeleportCache() {
        ...
        for (Entity e : world.getEntitiesWithinAABB(Entity.class, getMultiblock().getBounds().toAxisAlignedBB())) {
            ...
            if (!entitiesToTeleport.isEmpty()) {
                ...
                for (Entity entity : entitiesToTeleport) {
                    ...
                    for (Coord4D coords : activeCoords) {
                        ...
                        if (tile != null) {
                            TeleporterMultiblockData multiblock = tile.getMultiblock();
    ...
    public static void teleportEntityTo(Entity entity, Coord4D coord, TileEntityTeleporter teleporter) {
        ...
        if (!multiblock.isFormed()) {
            ...
            target = multiblock.getTeleportTargetCoords();
        }
    ...
    private List<Entity> getToTeleport() {
        ...
        TeleporterMultiblockData multiblock = getMultiblock();
        return world == null || !multiblock.isFormed()
                ? Collections.emptyList()
                : world.getEntitiesWithinAABB(
                        Entity.class,
                        multiblock.getBounds().toAxisAlignedBB(),
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        ...
        return multiblock.getBounds().toAxisAlignedBB().shrink(0.46);
    }
