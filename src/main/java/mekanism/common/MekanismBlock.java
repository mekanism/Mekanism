...
public enum MekanismBlock implements IBlockProvider {
    ...
    LIGHT_GRAY_SLICK_PLASTIC_BLOCK(new BlockPlasticSlick(EnumColor.GREY), ItemBlockPlasticSlick::new),
    GRAY_SLICK_PLASTIC_BLOCK(new BlockPlasticSlick(EnumColor.DARK_GREY), ItemBlockPlasticSlick::new),
    ...
    LIGHT_GRAY_PLASTIC_GLOW_BLOCK(new BlockPlasticGlow(EnumColor.GREY), ItemBlockPlasticGlow::new),
    GRAY_PLASTIC_GLOW_BLOCK(new BlockPlasticGlow(EnumColor.DARK_GREY), ItemBlockPlasticGlow::new),
    ...
    LIGHT_GRAY_REINFORCED_PLASTIC_BLOCK(new BlockPlasticReinforced(EnumColor.GREY), ItemBlockPlasticReinforced::new),
    GRAY_REINFORCED_PLASTIC_BLOCK(new BlockPlasticReinforced(EnumColor.DARK_GREY), ItemBlockPlasticReinforced::new),
    ...
    LIGHT_GRAY_PLASTIC_ROAD(new BlockPlasticRoad(EnumColor.GREY), ItemBlockPlasticRoad::new),
    GRAY_PLASTIC_ROAD(new BlockPlasticRoad(EnumColor.DARK_GREY), ItemBlockPlasticRoad::new),
    ...
    LIGHT_GRAY_PLASTIC_FENCE(new BlockPlasticFence(EnumColor.GREY), ItemBlockPlasticFence::new),
    GRAY_PLASTIC_FENCE(new BlockPlasticFence(EnumColor.DARK_GREY), ItemBlockPlasticFence::new),
    ...
    public static void registerBlocks(IForgeRegistry<Block> registry) {
        for (MekanismBlock mekanismBlock : values()) {
            ...
            block.setTranslationKey("mekanism." + mekanismBlock.getName());
