...
public class MultiblockGasTank<MULTIBLOCK extends TileEntityMultiblock<?>> extends VariableCapacityGasTank {
    ...
    public static <MULTIBLOCK extends TileEntityMultiblock<?>> MultiblockGasTank<MULTIBLOCK> create(MULTIBLOCK multiblock, IntSupplier capacity, Predicate<@NonNull Gas> validator) {
        return new MultiblockGasTank<>(multiblock, capacity, validator);
    }

    public static <MULTIBLOCK extends TileEntityMultiblock<?>> MultiblockGasTank<MULTIBLOCK> create(MULTIBLOCK multiblock, IntSupplier capacity,
    ...
    public static <MULTIBLOCK extends TileEntityMultiblock<?>> MultiblockGasTank<MULTIBLOCK> create(MULTIBLOCK tile, IntSupplier capacity, BiPredicate<@NonNull Gas, @NonNull AutomationType> canExtract,
    ...
    protected MultiblockGasTank(MULTIBLOCK multiblock, IntSupplier capacity, BiPredicate<@NonNull Gas, @NonNull AutomationType> canExtract,
          BiPredicate<@NonNull Gas, @NonNull AutomationType> canInsert, Predicate<@NonNull Gas> validator, @Nullable ChemicalAttributeValidator attributeValidator,
          @Nullable IMekanismGasHandler gasHandler) {
