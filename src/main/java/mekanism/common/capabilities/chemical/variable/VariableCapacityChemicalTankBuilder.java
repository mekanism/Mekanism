...
public class VariableCapacityChemicalTankBuilder<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>, TANK extends IChemicalTank<CHEMICAL, STACK>> {
    ...
    public static final VariableCapacityChemicalTankBuilder<InfuseType, InfusionStack, IInfusionTank> INFUSION = new VariableCapacityChemicalTankBuilder<>(ChemicalTankBuilder.INFUSION, VariableCapacityInfusionTank::new);
    public static final VariableCapacityChemicalTankBuilder<Pigment, PigmentStack, IPigmentTank> PIGMENT = new VariableCapacityChemicalTankBuilder<>(ChemicalTankBuilder.PIGMENT, VariableCapacityPigmentTank::new);
    public static final VariableCapacityChemicalTankBuilder<Slurry, SlurryStack, ISlurryTank> SLURRY = new VariableCapacityChemicalTankBuilder<>(ChemicalTankBuilder.SLURRY, VariableCapacitySlurryTank::new);

    private final VariableCapacityTankCreator<CHEMICAL, STACK, TANK> tankCreator;
    private final ChemicalTankBuilder<CHEMICAL, STACK, TANK> tankBuilder;

    private VariableCapacityChemicalTankBuilder(ChemicalTankBuilder<CHEMICAL, STACK, TANK> tankBuilder, VariableCapacityTankCreator<CHEMICAL, STACK, TANK> tankCreator) {
