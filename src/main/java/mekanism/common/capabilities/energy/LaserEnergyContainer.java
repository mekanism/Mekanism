...
public class LaserEnergyContainer extends BasicEnergyContainer {
    ...
    public static LaserEnergyContainer create(Predicate<AutomationType> canExtract, Predicate<AutomationType> canInsert, TileEntityMekanism tile,
    ...
    private LaserEnergyContainer(long maxEnergy, Predicate<AutomationType> canExtract, Predicate<AutomationType> canInsert,
