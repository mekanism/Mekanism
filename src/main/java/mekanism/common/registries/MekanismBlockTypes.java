...
public class MekanismBlockTypes {
    ...
    public static final BlockTypeTile<TileEntityPersonalBarrel> PERSONAL_BARREL = BlockTileBuilder
          ...
          .with(Attributes.SECURITY, BlockPersonalChest.PERSONAL_STORAGE_INVENTORY, AttributeStateOpen.INSTANCE, new AttributeStateFacing(BlockStateProperties.FACING), new AttributeCustomResistance(-1))
    ...
    public static final BlockTypeTile<TileEntityPersonalChest> PERSONAL_CHEST = BlockTileBuilder
          ...
          .withGui(() -> MekanismContainerTypes.PERSONAL_STORAGE_BLOCK)
          .with(Attributes.SECURITY, BlockPersonalChest.PERSONAL_STORAGE_INVENTORY, new AttributeStateFacing(), new AttributeCustomResistance(-1))
