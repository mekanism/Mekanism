...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<TileEntityPigmentExtractor, Machine<TileEntityPigmentExtractor>>, ItemBlockMachine> PIGMENT_EXTRACTOR = BLOCKS.register("pigment_extractor", () -> new BlockTileModel<>(MekanismBlockTypes.PIGMENT_EXTRACTOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockTileModel<TileEntityPigmentMixer, Machine<TileEntityPigmentMixer>>, ItemBlockMachine> PIGMENT_MIXER = BLOCKS.register("pigment_mixer", () -> new BlockTileModel<>(MekanismBlockTypes.PIGMENT_MIXER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockTileModel<TileEntityPaintingMachine, Machine<TileEntityPaintingMachine>>, ItemBlockMachine> PAINTING_MACHINE = BLOCKS.register("painting_machine", () -> new BlockTileModel<>(MekanismBlockTypes.PAINTING_MACHINE), ItemBlockMachine::new);
