...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityEnrichmentChamber>, ItemBlockMachine> ENRICHMENT_CHAMBER = BLOCKS.register("enrichment_chamber", () -> new BlockFactoryMachine<>(MekanismMachines.ENRICHMENT_CHAMBER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityOsmiumCompressor>, ItemBlockMachine> OSMIUM_COMPRESSOR = BLOCKS.register("osmium_compressor", () -> new BlockFactoryMachine<>(MekanismMachines.OSMIUM_COMPRESSOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityCombiner>, ItemBlockMachine> COMBINER = BLOCKS.register("combiner", () -> new BlockFactoryMachine<>(MekanismMachines.COMBINER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityCrusher>, ItemBlockMachine> CRUSHER = BLOCKS.register("crusher", () -> new BlockFactoryMachine<>(MekanismMachines.CRUSHER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityDigitalMiner, Machine<TileEntityDigitalMiner>>, ItemBlockDigitalMiner> DIGITAL_MINER = BLOCKS.register("digital_miner", () -> new BlockMachineModel<>(MekanismMachines.DIGITAL_MINER), ItemBlockDigitalMiner::new);
    ...
    public static final BlockRegistryObject<BlockFactoryMachineModel<TileEntityMetallurgicInfuser>, ItemBlockMachine> METALLURGIC_INFUSER = BLOCKS.register("metallurgic_infuser", () -> new BlockFactoryMachineModel<>(MekanismMachines.METALLURGIC_INFUSER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityPurificationChamber>, ItemBlockMachine> PURIFICATION_CHAMBER = BLOCKS.register("purification_chamber", () -> new BlockFactoryMachine<>(MekanismMachines.PURIFICATION_CHAMBER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityEnergizedSmelter>, ItemBlockMachine> ENERGIZED_SMELTER = BLOCKS.register("energized_smelter", () -> new BlockFactoryMachine<>(MekanismMachines.ENERGIZED_SMELTER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachineModel<TileEntityElectricPump, Machine<TileEntityElectricPump>>, ItemBlockMachine> ELECTRIC_PUMP = BLOCKS.register("electric_pump", () -> new BlockMachineModel<>(MekanismMachines.ELECTRIC_PUMP), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachineModel<TileEntityRotaryCondensentrator, Machine<TileEntityRotaryCondensentrator>>, ItemBlockMachine> ROTARY_CONDENSENTRATOR = BLOCKS.register("rotary_condensentrator", () -> new BlockMachineModel<>(MekanismMachines.ROTARY_CONDENSENTRATOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityChemicalOxidizer, Machine<TileEntityChemicalOxidizer>>, ItemBlockMachine> CHEMICAL_OXIDIZER = BLOCKS.register("chemical_oxidizer", () -> new BlockMachineModel<>(MekanismMachines.CHEMICAL_OXIDIZER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityChemicalInfuser, Machine<TileEntityChemicalInfuser>>, ItemBlockMachine> CHEMICAL_INFUSER = BLOCKS.register("chemical_infuser", () -> new BlockMachineModel<>(MekanismMachines.CHEMICAL_INFUSER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityChemicalInjectionChamber>, ItemBlockMachine> CHEMICAL_INJECTION_CHAMBER = BLOCKS.register("chemical_injection_chamber", () -> new BlockFactoryMachine<>(MekanismMachines.CHEMICAL_INJECTION_CHAMBER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityElectrolyticSeparator, Machine<TileEntityElectrolyticSeparator>>, ItemBlockMachine> ELECTROLYTIC_SEPARATOR = BLOCKS.register("electrolytic_separator", () -> new BlockMachineModel<>(MekanismMachines.ELECTROLYTIC_SEPARATOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityPrecisionSawmill>, ItemBlockMachine> PRECISION_SAWMILL = BLOCKS.register("precision_sawmill", () -> new BlockFactoryMachine<>(MekanismMachines.PRECISION_SAWMILL), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityChemicalDissolutionChamber, Machine<TileEntityChemicalDissolutionChamber>>, ItemBlockMachine> CHEMICAL_DISSOLUTION_CHAMBER = BLOCKS.register("chemical_dissolution_chamber", () -> new BlockMachineModel<>(MekanismMachines.CHEMICAL_DISSOLUTION_CHAMBER), (block) -> new ItemBlockMachine(block, ISTERProvider::dissolution));
    public static final BlockRegistryObject<BlockMachineModel<TileEntityChemicalWasher, Machine<TileEntityChemicalWasher>>, ItemBlockMachine> CHEMICAL_WASHER = BLOCKS.register("chemical_washer", () -> new BlockMachineModel<>(MekanismMachines.CHEMICAL_WASHER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachineModel<TileEntityChemicalCrystallizer, Machine<TileEntityChemicalCrystallizer>>, ItemBlockMachine> CHEMICAL_CRYSTALLIZER = BLOCKS.register("chemical_crystallizer", () -> new BlockMachineModel<>(MekanismMachines.CHEMICAL_CRYSTALLIZER), (block) -> new ItemBlockMachine(block, ISTERProvider::crystallizer));
    ...
    public static final BlockRegistryObject<BlockMachineModel<TileEntityPressurizedReactionChamber, Machine<TileEntityPressurizedReactionChamber>>, ItemBlockMachine> PRESSURIZED_REACTION_CHAMBER = BLOCKS.register("pressurized_reaction_chamber", () -> new BlockMachineModel<>(MekanismMachines.PRESSURIZED_REACTION_CHAMBER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachineModel<TileEntityFluidicPlenisher, Machine<TileEntityFluidicPlenisher>>, ItemBlockMachine> FLUIDIC_PLENISHER = BLOCKS.register("fluidic_plenisher", () -> new BlockMachineModel<>(MekanismMachines.FLUIDIC_PLENISHER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityFormulaicAssemblicator, Machine<TileEntityFormulaicAssemblicator>>, ItemBlockMachine> FORMULAIC_ASSEMBLICATOR = BLOCKS.register("formulaic_assemblicator", () -> new BlockMachine<>(MekanismMachines.FORMULAIC_ASSEMBLICATOR), ItemBlockMachine::new);
