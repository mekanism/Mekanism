...
import mekanism.common.block.machine.BlockFactoryMachine;
...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityDigitalMiner, Machine<TileEntityDigitalMiner>>, ItemBlockDigitalMiner> DIGITAL_MINER = BLOCKS.register("digital_miner", () -> new BlockMachine<>(MekanismMachines.DIGITAL_MINER), ItemBlockDigitalMiner::new);
    ...
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityMetallurgicInfuser>, ItemBlockMachine> METALLURGIC_INFUSER = BLOCKS.register("metallurgic_infuser", () -> new BlockFactoryMachine<>(MekanismMachines.METALLURGIC_INFUSER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityRotaryCondensentrator, Machine<TileEntityRotaryCondensentrator>>, ItemBlockMachine> ROTARY_CONDENSENTRATOR = BLOCKS.register("rotary_condensentrator", () -> new BlockMachine<>(MekanismMachines.ROTARY_CONDENSENTRATOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityChemicalOxidizer, Machine<TileEntityChemicalOxidizer>>, ItemBlockMachine> CHEMICAL_OXIDIZER = BLOCKS.register("chemical_oxidizer", () -> new BlockMachine<>(MekanismMachines.CHEMICAL_OXIDIZER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityChemicalInfuser, Machine<TileEntityChemicalInfuser>>, ItemBlockMachine> CHEMICAL_INFUSER = BLOCKS.register("chemical_infuser", () -> new BlockMachine<>(MekanismMachines.CHEMICAL_INFUSER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityElectrolyticSeparator, Machine<TileEntityElectrolyticSeparator>>, ItemBlockMachine> ELECTROLYTIC_SEPARATOR = BLOCKS.register("electrolytic_separator", () -> new BlockMachine<>(MekanismMachines.ELECTROLYTIC_SEPARATOR), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityChemicalDissolutionChamber, Machine<TileEntityChemicalDissolutionChamber>>, ItemBlockMachine> CHEMICAL_DISSOLUTION_CHAMBER = BLOCKS.register("chemical_dissolution_chamber", () -> new BlockMachine<>(MekanismMachines.CHEMICAL_DISSOLUTION_CHAMBER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityChemicalWasher, Machine<TileEntityChemicalWasher>>, ItemBlockMachine> CHEMICAL_WASHER = BLOCKS.register("chemical_washer", () -> new BlockMachine<>(MekanismMachines.CHEMICAL_WASHER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityChemicalCrystallizer, Machine<TileEntityChemicalCrystallizer>>, ItemBlockMachine> CHEMICAL_CRYSTALLIZER = BLOCKS.register("chemical_crystallizer", () -> new BlockMachine<>(MekanismMachines.CHEMICAL_CRYSTALLIZER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityPressurizedReactionChamber, Machine<TileEntityPressurizedReactionChamber>>, ItemBlockMachine> PRESSURIZED_REACTION_CHAMBER = BLOCKS.register("pressurized_reaction_chamber", () -> new BlockMachine<>(MekanismMachines.PRESSURIZED_REACTION_CHAMBER), ItemBlockMachine::new);
