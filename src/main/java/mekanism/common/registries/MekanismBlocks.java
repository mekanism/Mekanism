...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityTeleporter, Machine<TileEntityTeleporter>>, ItemBlockMachine> TELEPORTER = BLOCKS.register("teleporter", () -> new BlockMachine<>(MekanismBlockTypes.TELEPORTER), ItemBlockMachine::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityOredictionificator, BlockTile<TileEntityOredictionificator>>, ItemBlockOredictionificator> OREDICTIONIFICATOR = BLOCKS.register("oredictionificator", () -> new BlockMachine<>(MekanismBlockTypes.OREDICTIONIFICATOR), ItemBlockOredictionificator::new);
    ...
    public static final BlockRegistryObject<BlockMachine<TileEntityFormulaicAssemblicator, Machine<TileEntityFormulaicAssemblicator>>, ItemBlockMachine> FORMULAIC_ASSEMBLICATOR = BLOCKS.register("formulaic_assemblicator", () -> new BlockMachine<>(MekanismBlockTypes.FORMULAIC_ASSEMBLICATOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityFuelwoodHeater, BlockTile<TileEntityFuelwoodHeater>>, ItemBlockFuelwoodHeater> FUELWOOD_HEATER = BLOCKS.register("fuelwood_heater", () -> new BlockMachine<>(MekanismBlockTypes.FUELWOOD_HEATER), ItemBlockFuelwoodHeater::new);
