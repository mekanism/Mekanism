...
import mekanism.common.item.block.machine.ItemBlockCreativeLaser;
...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<TileEntityCreativeLaser, BlockTypeTile<TileEntityCreativeLaser>>, ItemBlockCreativeLaser> CREATIVE_LASER = BLOCKS.register("creative_laser", () -> new BlockTileModel<>(MekanismBlockTypes.CREATIVE_LASER), ItemBlockCreativeLaser::new);
