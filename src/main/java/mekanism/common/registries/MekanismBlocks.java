...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityEnrichmentChamber>, ItemBlockMachine> ENRICHMENT_CHAMBER = BLOCKS.register("enrichment_chamber", () -> new BlockFactoryMachine<TileEntityEnrichmentChamber>(MekanismMachines.ENRICHMENT_CHAMBER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityOsmiumCompressor>, ItemBlockMachine> OSMIUM_COMPRESSOR = BLOCKS.register("osmium_compressor", () -> new BlockFactoryMachine<TileEntityOsmiumCompressor>(MekanismMachines.OSMIUM_COMPRESSOR), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityCombiner>, ItemBlockMachine> COMBINER = BLOCKS.register("combiner", () -> new BlockFactoryMachine<TileEntityCombiner>(MekanismMachines.COMBINER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityCrusher>, ItemBlockMachine> CRUSHER = BLOCKS.register("crusher", () -> new BlockFactoryMachine<TileEntityCrusher>(MekanismMachines.CRUSHER), ItemBlockMachine::new);
    public static final BlockRegistryObject<BlockMachine<TileEntityDigitalMiner, Machine<TileEntityDigitalMiner>>, ItemBlockDigitalMiner> DIGITAL_MINER = BLOCKS.register("digital_miner", () -> new BlockMachine<TileEntityDigitalMiner, Machine<TileEntityDigitalMiner>>(MekanismMachines.DIGITAL_MINER), ItemBlockDigitalMiner::new);
    ...
    public static final BlockRegistryObject<BlockFactoryMachine<TileEntityMetallurgicInfuser>, ItemBlockMachine> METALLURGIC_INFUSER = BLOCKS.register("metallurgic_infuser", () -> new BlockFactoryMachine<TileEntityMetallurgicInfuser>(MekanismMachines.METALLURGIC_INFUSER), ItemBlockMachine::new);
