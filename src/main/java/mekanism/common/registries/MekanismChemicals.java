...
public class MekanismChemicals {
    ...
    public static final DeferredChemical<Chemical> BIO = CHEMICALS.register("bio", Mekanism.rl("mek_chemical/infuse_type/bio"), 0xFF5A4630);
    public static final DeferredChemical<Chemical> FUNGI = CHEMICALS.register("fungi", Mekanism.rl("mek_chemical/infuse_type/fungi"), 0xFF74656A);
    public static final DeferredChemical<Chemical> TIN = CHEMICALS.registerInfuse("tin", 0xFFCCCCD9);
    public static final DeferredChemical<Chemical> GOLD = CHEMICALS.registerInfuse("gold", 0xFFF2CD67);
    public static final DeferredChemical<Chemical> REFINED_OBSIDIAN = CHEMICALS.registerInfuse("refined_obsidian", 0xFF7C00ED);
    public static final DeferredChemical<Chemical> DIAMOND = CHEMICALS.registerInfuse("diamond", 0xFF6CEDD8);
    public static final DeferredChemical<Chemical> REDSTONE = CHEMICALS.registerInfuse("redstone", 0xFFB30505);
    public static final DeferredChemical<Chemical> CARBON = CHEMICALS.registerInfuse("carbon", 0xFF2C2C2C);
    ...
    public static final DeferredChemical<Chemical> BRINE = CHEMICALS.register("brine", 0xFFFEEF9C);
    public static final DeferredChemical<Chemical> LITHIUM = CHEMICALS.register(ChemicalConstants.LITHIUM);
    public static final DeferredChemical<Chemical> OSMIUM = CHEMICALS.register("osmium", 0xFF52BDCA);
    public static final DeferredChemical<Chemical> FISSILE_FUEL = CHEMICALS.register("fissile_fuel", 0xFF2E332F);
    public static final DeferredChemical<Chemical> NUCLEAR_WASTE = CHEMICALS.register("nuclear_waste", 0xFF4F412A);
    public static final DeferredChemical<Chemical> SPENT_NUCLEAR_WASTE = CHEMICALS.register("spent_nuclear_waste", 0xFF262015);
    public static final DeferredChemical<Chemical> PLUTONIUM = CHEMICALS.register("plutonium", 0xFF1F919C);
