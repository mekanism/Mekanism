...
public class MekanismModules {
    ...
    //Shared
    public static final ModuleRegistryObject<ModuleEnergyUnit> ENERGY_UNIT = MODULES.registerInstanced("energy_unit", ModuleEnergyUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).maxStackSize(8).noDisable());
    //Shared Armor
    public static final ModuleRegistryObject<ModuleColorModulationUnit> COLOR_MODULATION_UNIT = MODULES.register("color_modulation_unit", ModuleColorModulationUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).noDisable()
    ...
    public static final ModuleRegistryObject<?> LASER_DISSIPATION_UNIT = MODULES.registerMarker("laser_dissipation_unit", builder -> builder.rarity(Rarity.UNCOMMON));
    public static final ModuleRegistryObject<?> RADIATION_SHIELDING_UNIT = MODULES.registerMarker("radiation_shielding_unit", builder -> builder.rarity(Rarity.UNCOMMON));

    //Meka-Tool
    public static final ModuleRegistryObject<ModuleExcavationEscalationUnit> EXCAVATION_ESCALATION_UNIT = MODULES.register("excavation_escalation_unit", ModuleExcavationEscalationUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).maxStackSize(4).handlesModeChange().rendersHUD()
    ...
    public static final ModuleRegistryObject<ModuleAttackAmplificationUnit> ATTACK_AMPLIFICATION_UNIT = MODULES.register("attack_amplification_unit", ModuleAttackAmplificationUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).maxStackSize(4).rendersHUD()
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<ModuleFarmingUnit> FARMING_UNIT = MODULES.register("farming_unit", ModuleFarmingUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).maxStackSize(4).exclusive(ExclusiveFlag.INTERACT_BLOCK)
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<ModuleShearingUnit> SHEARING_UNIT = MODULES.registerInstanced("shearing_unit", ModuleShearingUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).exclusive(ExclusiveFlag.INTERACT_ENTITY, ExclusiveFlag.INTERACT_BLOCK));
    public static final ModuleRegistryObject<SimpleEnchantmentAwareModule> SILK_TOUCH_UNIT = MODULES.registerEnchantBased("silk_touch_unit",
          Enchantments.SILK_TOUCH, builder -> builder.rarity(Rarity.RARE).exclusive(ExclusiveFlag.OVERRIDE_DROPS));
    public static final ModuleRegistryObject<SimpleEnchantmentAwareModule> FORTUNE_UNIT = MODULES.registerEnchantBased("fortune_unit", Enchantments.FORTUNE, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(3).exclusive(ExclusiveFlag.OVERRIDE_DROPS));
    public static final ModuleRegistryObject<ModuleBlastingUnit> BLASTING_UNIT = MODULES.register("blasting_unit", ModuleBlastingUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange().rendersHUD()
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<ModuleVeinMiningUnit> VEIN_MINING_UNIT = MODULES.register("vein_mining_unit", ModuleVeinMiningUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange().rendersHUD()
    ...
    public static final ModuleRegistryObject<ModuleTeleportationUnit> TELEPORTATION_UNIT = MODULES.register("teleportation_unit", ModuleTeleportationUnit::new, builder -> builder
          .rarity(Rarity.EPIC).exclusive(ExclusiveFlag.INTERACT_ANY)
          .addConfig(ModuleBooleanConfig.create(ModuleTeleportationUnit.REQUIRE_TARGET, true))
    );

    //Helmet
    public static final ModuleRegistryObject<ModuleElectrolyticBreathingUnit> ELECTROLYTIC_BREATHING_UNIT = MODULES.register("electrolytic_breathing_unit", ModuleElectrolyticBreathingUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).maxStackSize(4)
          .addConfig(ModuleBooleanConfig.create(ModuleElectrolyticBreathingUnit.FILL_HELD, true))
    );
    public static final ModuleRegistryObject<ModuleInhalationPurificationUnit> INHALATION_PURIFICATION_UNIT = MODULES.register("inhalation_purification_unit", ModuleInhalationPurificationUnit::new, builder -> builder
          .rarity(Rarity.RARE)
    ...
    public static final ModuleRegistryObject<ModuleVisionEnhancementUnit> VISION_ENHANCEMENT_UNIT = MODULES.registerInstanced("vision_enhancement_unit", ModuleVisionEnhancementUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange().rendersHUD().disabledByDefault());
    public static final ModuleRegistryObject<ModuleNutritionalInjectionUnit> NUTRITIONAL_INJECTION_UNIT = MODULES.registerInstanced("nutritional_injection_unit", ModuleNutritionalInjectionUnit::new, builder -> builder
          .rarity(Rarity.RARE).rendersHUD());

    //Chestplate
    public static final ModuleRegistryObject<ModuleDosimeterUnit> DOSIMETER_UNIT = MODULES.registerInstanced("dosimeter_unit", ModuleDosimeterUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).rendersHUD());
    public static final ModuleRegistryObject<ModuleGeigerUnit> GEIGER_UNIT = MODULES.registerInstanced("geiger_unit", ModuleGeigerUnit::new, builder -> builder
          .rarity(Rarity.UNCOMMON).rendersHUD());
    public static final ModuleRegistryObject<ModuleJetpackUnit> JETPACK_UNIT = MODULES.register("jetpack_unit", ModuleJetpackUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange().rendersHUD()
    ...
    public static final ModuleRegistryObject<ModuleChargeDistributionUnit> CHARGE_DISTRIBUTION_UNIT = MODULES.register("charge_distribution_unit", ModuleChargeDistributionUnit::new, builder -> builder
          .rarity(Rarity.RARE)
    ...
    public static final ModuleRegistryObject<ModuleGravitationalModulatingUnit> GRAVITATIONAL_MODULATING_UNIT = MODULES.register("gravitational_modulating_unit", ModuleGravitationalModulatingUnit::new, builder -> builder
          .rarity(Rarity.EPIC).handlesModeChange()
    ...
    public static final ModuleRegistryObject<ModuleElytraUnit> ELYTRA_UNIT = MODULES.registerInstanced("elytra_unit", ModuleElytraUnit::new, builder -> builder
          .rarity(Rarity.EPIC).handlesModeChange().modeChangeDisabledByDefault());

    //Pants
    public static final ModuleRegistryObject<ModuleLocomotiveBoostingUnit> LOCOMOTIVE_BOOSTING_UNIT = MODULES.register("locomotive_boosting_unit", ModuleLocomotiveBoostingUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange()
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<GyroscopicStabilizationUnit> GYROSCOPIC_STABILIZATION_UNIT = MODULES.registerInstanced("gyroscopic_stabilization_unit",
          GyroscopicStabilizationUnit::new, builder -> builder.rarity(Rarity.RARE));
    public static final ModuleRegistryObject<ModuleHydrostaticRepulsorUnit> HYDROSTATIC_REPULSOR_UNIT = MODULES.register("hydrostatic_repulsor_unit", ModuleHydrostaticRepulsorUnit::new, builder -> builder
          ...
          .addInstalledCountConfig(
                ...
                _ -> ModuleBooleanConfig.create(ModuleHydrostaticRepulsorUnit.SWIM_BOOST, true),
                _ -> ModuleBooleanConfig.CODEC,
                _ -> ModuleBooleanConfig.STREAM_CODEC
          )
    );
    public static final ModuleRegistryObject<MotorizedServoUnit> MOTORIZED_SERVO_UNIT = MODULES.registerInstanced("motorized_servo_unit", MotorizedServoUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(5));

    //Boots
    public static final ModuleRegistryObject<ModuleHydraulicPropulsionUnit> HYDRAULIC_PROPULSION_UNIT = MODULES.register("hydraulic_propulsion_unit", ModuleHydraulicPropulsionUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4)
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<ModuleMagneticAttractionUnit> MAGNETIC_ATTRACTION_UNIT = MODULES.register("magnetic_attraction_unit", ModuleMagneticAttractionUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(4).handlesModeChange()
          .addInstalledCountConfig(
    ...
    public static final ModuleRegistryObject<SimpleEnchantmentAwareModule> FROST_WALKER_UNIT = MODULES.registerEnchantBased("frost_walker_unit", Enchantments.FROST_WALKER, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(2));
    public static final ModuleRegistryObject<SoulSurferUnit> SOUL_SURFER_UNIT = MODULES.registerInstanced("soul_surfer_unit", SoulSurferUnit::new, builder -> builder
          .rarity(Rarity.RARE).maxStackSize(3));
}
