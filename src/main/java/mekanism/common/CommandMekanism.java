        ...
        if (params.length < 1) {
            ...
            if (params[0].equalsIgnoreCase("help")) {
                ...
                if (!MekanismUtils.checkForUpdates((EntityPlayer) sender)) {
                    if (MekanismConfig.current().general.updateNotifications.val()
                          || Mekanism.latestVersionNumber == null || Mekanism.recentNews == null
                          || Mekanism.latestVersionNumber.equals("null")) {
