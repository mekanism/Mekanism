        ...
        public static void useDropper(EntityPlayer player, Object tank, int button) {
            ...
            if (!stack.isEmpty()) {
                if (tank instanceof GasTank) {
                    ...
                    if (dropper.getGas(stack) != null && gasTank.getGas() != null && !dropper.getGas(stack)
                          .isGasEqual(gasTank.getGas())) {
                        return;
                    }
                    ...
                    int dropperStored =
                          FluidUtil.getFluidContained(stack) != null ? FluidUtil.getFluidContained(stack).amount : 0;

                    if (FluidUtil.getFluidContained(stack) != null && fluidTank.getFluid() != null && !FluidUtil
                          .getFluidContained(stack).isFluidEqual(fluidTank.getFluid())) {
                        return;
                    }
