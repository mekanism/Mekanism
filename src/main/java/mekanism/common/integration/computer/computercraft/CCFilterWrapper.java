...
/**
 * Wrap a filter as a copy that can be modified by instance methods on the CC side.
 * Clones the filter on creation and output to ensure the filter is not modified while in use.
 *
