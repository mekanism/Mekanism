...
public abstract class BoundMethodHolder {
    ...
    public <T> void register(String name, boolean threadSafe, String[] argumentNames, Class<?>[] argClasses, Class<?> returnType, WeakReference<T> subject, ComputerMethodFactory.ComputerFunctionCaller<T> handler) {
        ...
        this.methods.put(name, new MethodData<>(name, threadSafe, argumentNames, argClasses, returnType, subject, handler));
    }

    public record MethodData<T>(String name, boolean threadSafe, String[] argumentNames, Class<?>[] argClasses, Class<?> returnType, @Nullable WeakReference<T> subject, ComputerMethodFactory.ComputerFunctionCaller<T> handler){
