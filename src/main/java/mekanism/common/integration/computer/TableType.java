...
public record TableType(String description, String humanName, Map<String, FieldType> fields, @Nullable Class<?> extendedFrom) {
    ...
    public static Codec<TableType> CODEC = RecordCodecBuilder.create(instance -> instance.group(
          ...
          MekCodecs.CLASS_TO_STRING_CODEC.optionalFieldOf(SerializationConstants.EXTENDS).forGetter(type -> Optional.ofNullable(type.extendedFrom()))
    ).apply(instance, (description, humanName, fields, extendedFrom) -> new TableType(description, humanName, fields, extendedFrom.orElse(null))));
    ...
    public record FieldType(String description, Class<?> javaType, String type, Class<?>[] javaExtra) {
        ...
        public static final Codec<FieldType> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    public static class Builder {
        ...
        public Builder addField(String name, Class<?> javaType, String description, Class<?> @Nullable ... javaExtra) {
            if (javaExtra == null) {
