...
/// Central place for Factories to be registered and bound. Registries should be registered as an IComputerMethodRegistry service. [#bindTo] is used to gather methods for
/// a subject or class (static methods only, or it would explode at runtime) Factories are constructed lazily to reduce initialization time.
public class FactoryRegistry {
    ...
    /// Gets Factories for target and its superclasses. Recursive! via [#getHandlersForHierarchy(Class)] to store parents which we don't know
    ///
