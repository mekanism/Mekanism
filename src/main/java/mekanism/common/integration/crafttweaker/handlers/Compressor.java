...
public class Compressor
{
    ...
    public static void addRecipe(IItemStack itemInput, IItemStack itemOutput)
    {
        ...
        CraftTweakerAPI.apply(new AddMekanismRecipe(NAME, RecipeHandler.Recipe.OSMIUM_COMPRESSOR.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient itemOutput, @Optional IIngredient itemInput, @Optional IIngredient gasInput)
    {
        ...
        if (!recipes.isEmpty())
        {
            CraftTweakerAPI.apply(new RemoveMekanismRecipe(NAME, RecipeHandler.Recipe.OSMIUM_COMPRESSOR.get(), recipes));
        }
        else
        {
