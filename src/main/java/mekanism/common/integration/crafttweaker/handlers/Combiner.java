...
public class Combiner {
    ...
    public static void addRecipe(IItemStack itemInput, IItemStack extraInput, IItemStack itemOutput) {
        ...
        DoubleMachineInput input = new DoubleMachineInput(InputHelper.toStack(itemInput),
              InputHelper.toStack(extraInput));
        ...
        CrafttweakerIntegration.LATE_ADDITIONS
              .add(new AddMekanismRecipe<>(NAME, RecipeHandler.Recipe.COMBINER.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient itemOutput, @Optional IIngredient itemInput,
        ...
        CrafttweakerIntegration.LATE_REMOVALS
              .add(new Remove(NAME, RecipeHandler.Recipe.COMBINER.get(), itemOutput, itemInput, gasInput));
    }
    ...
    private static class Remove extends RemoveMekanismRecipe<DoubleMachineInput, CombinerRecipe> {
        ...
        public Remove(String name, Map<DoubleMachineInput, CombinerRecipe> map, IIngredient itemOutput,
              IIngredient itemInput, IIngredient extraInput) {
            super(name, map);
        ...
        public void addRecipes() {
            ...
            if (!recipesToRemove.isEmpty()) {
                ...
                LogHelper.logInfo(String.format("No %s recipe found for %s, %s and %s. Command ignored!", NAME,
                      itemInput.toString(), itemExtra.toString(), itemOutput.toString()));
            }
        }
    }
}
