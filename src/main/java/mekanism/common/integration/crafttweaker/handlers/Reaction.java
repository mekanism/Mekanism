...
public class Reaction {
    ...
    public static void addRecipe(IItemStack itemInput, ILiquidStack liquidInput, IGasStack gasInput,
        ...
        PressurizedInput input = new PressurizedInput(InputHelper.toStack(itemInput), InputHelper.toFluid(liquidInput),
        ...
        CrafttweakerIntegration.LATE_ADDITIONS
              .add(new AddMekanismRecipe<>(NAME, RecipeHandler.Recipe.PRESSURIZED_REACTION_CHAMBER.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient itemOutput, IIngredient gasOutput, @Optional IIngredient itemInput,
        ...
        CrafttweakerIntegration.LATE_REMOVALS
              .add(new Remove(NAME, RecipeHandler.Recipe.PRESSURIZED_REACTION_CHAMBER.get(), itemOutput, gasOutput,
                    itemInput, liquidInput, gasInput));
    }
    ...
    private static class Remove extends RemoveMekanismRecipe<PressurizedInput, PressurizedRecipe> {
        ...
        public Remove(String name, Map<PressurizedInput, PressurizedRecipe> map, IIngredient itemOutput,
              IIngredient gasOutput, IIngredient itemInput, IIngredient liquidInput, IIngredient gasInput) {
            super(name, map);
        ...
        public void addRecipes() {
            ...
            for (Map.Entry<PressurizedInput, PressurizedRecipe> entry : RecipeHandler.Recipe.PRESSURIZED_REACTION_CHAMBER
                  .get().entrySet()) {
            ...
            if (!recipesToRemove.isEmpty()) {
                ...
                LogHelper.logInfo(String.format("No %s recipe found for %s, %s, %s, %s and %s. Command ignored!", NAME,
                      itemOutput.toString(), gasOutput.toString(), itemInput.toString(), liquidInput.toString(),
                      gasInput.toString()));
            }
        }
    }
