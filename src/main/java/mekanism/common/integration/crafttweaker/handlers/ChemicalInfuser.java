...
public class ChemicalInfuser {
    ...
    public static void addRecipe(IGasStack leftGasInput, IGasStack rightGasInput, IGasStack gasOutput) {
        ...
        ChemicalInfuserRecipe recipe = new ChemicalInfuserRecipe(GasHelper.toGas(leftGasInput),
              GasHelper.toGas(rightGasInput), GasHelper.toGas(gasOutput));

        CrafttweakerIntegration.LATE_ADDITIONS
              .add(new AddMekanismRecipe<>(NAME, RecipeHandler.Recipe.CHEMICAL_INFUSER.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient gasOutput, @Optional IIngredient leftGasInput,
        ...
        CrafttweakerIntegration.LATE_REMOVALS
              .add(new Remove(NAME, RecipeHandler.Recipe.CHEMICAL_INFUSER.get(), gasOutput, leftGasInput,
                    rightGasInput));
    }
    ...
    private static class Remove extends RemoveMekanismRecipe<ChemicalPairInput, ChemicalInfuserRecipe> {
        ...
        public Remove(String name, Map<ChemicalPairInput, ChemicalInfuserRecipe> map, IIngredient gasOutput,
              IIngredient leftGasInput, IIngredient rightGasInput) {
            super(name, map);
        ...
        public void addRecipes() {
            ...
            for (Map.Entry<ChemicalPairInput, ChemicalInfuserRecipe> entry : RecipeHandler.Recipe.CHEMICAL_INFUSER.get()
                  .entrySet()) {
            ...
            if (!recipesToRemove.isEmpty()) {
                ...
                LogHelper.logInfo(String.format("No %s recipe found for %s, %s and %s. Command ignored!", NAME,
                      gasOutput.toString(), leftGasInput.toString(), rightGasInput.toString()));
            }
        }
    }
}
