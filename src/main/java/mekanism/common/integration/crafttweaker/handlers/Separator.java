...
public class Separator {
    ...
    public static void addRecipe(ILiquidStack liquidInput, double energy, IGasStack leftGasOutput,
        ...
        SeparatorRecipe recipe = new SeparatorRecipe(InputHelper.toFluid(liquidInput), energy,
              GasHelper.toGas(leftGasOutput), GasHelper.toGas(rightGasOutput));

        CrafttweakerIntegration.LATE_ADDITIONS
              .add(new AddMekanismRecipe<>(NAME, RecipeHandler.Recipe.ELECTROLYTIC_SEPARATOR.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient liquidInput, @Optional IIngredient leftGasInput,
        ...
        CrafttweakerIntegration.LATE_REMOVALS
              .add(new Remove(NAME, RecipeHandler.Recipe.ELECTROLYTIC_SEPARATOR.get(), liquidInput, leftGasInput,
                    rightGasInput));
    }
    ...
    private static class Remove extends RemoveMekanismRecipe<FluidInput, SeparatorRecipe> {
        ...
        public Remove(String name, Map<FluidInput, SeparatorRecipe> map, IIngredient liquidInput,
        ...
        public void addRecipes() {
            ...
            for (Map.Entry<FluidInput, SeparatorRecipe> entry : RecipeHandler.Recipe.ELECTROLYTIC_SEPARATOR.get()
                  .entrySet()) {
            ...
            if (!recipesToRemove.isEmpty()) {
                ...
                LogHelper.logInfo(String.format("No %s recipe found for %s, %s and %s. Command ignored!", NAME,
                      liquidInput.toString(), leftGasInput.toString(), rightGasInput.toString()));
            }
        }
    }
}
