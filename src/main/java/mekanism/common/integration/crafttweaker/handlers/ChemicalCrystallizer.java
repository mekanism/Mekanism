...
public class ChemicalCrystallizer {
    ...
    public static void addRecipe(IGasStack gasInput, IItemStack itemOutput) {
        ...
        CrafttweakerIntegration.LATE_ADDITIONS
              .add(new AddMekanismRecipe<>(NAME, RecipeHandler.Recipe.CHEMICAL_CRYSTALLIZER.get(), recipe));
    }
    ...
    public static void removeRecipe(IIngredient itemOutput, @Optional IIngredient gasInput) {
        ...
        CrafttweakerIntegration.LATE_REMOVALS
              .add(new Remove(NAME, RecipeHandler.Recipe.CHEMICAL_CRYSTALLIZER.get(), itemOutput, gasInput));
    }
    ...
    private static class Remove extends RemoveMekanismRecipe<GasInput, CrystallizerRecipe> {
        ...
        public Remove(String name, Map<GasInput, CrystallizerRecipe> map, IIngredient itemOutput,
        ...
        public void addRecipes() {
            ...
            for (Map.Entry<GasInput, CrystallizerRecipe> entry : RecipeHandler.Recipe.CHEMICAL_CRYSTALLIZER.get()
                  .entrySet()) {
            ...
            if (!recipesToRemove.isEmpty()) {
                ...
                LogHelper.logInfo(
                      String.format("No %s recipe found for %s and %s. Command ignored!", NAME, gasInput.toString(),
                            itemOutput.toString()));
            }
        }
    }
