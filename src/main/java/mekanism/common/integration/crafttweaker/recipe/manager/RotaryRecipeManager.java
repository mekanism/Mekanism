...
public class RotaryRecipeManager extends MekanismRecipeManager<RotaryRecipe> {
     ...
     */
    public final RotaryRecipe makeRecipe(FluidStackIngredient fluidInput, ICrTGasStack gasOutput) {
     ...
     */
    public final RotaryRecipe makeRecipe(FluidStackIngredient fluidInput, GasStackIngredient gasInput, ICrTGasStack gasOutput, IFluidStack fluidOutput) {
