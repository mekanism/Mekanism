...
public interface ICrTChemicalStack extends CommandStringDisplayable {
    ...
    ///
    /// @return `true` if this stack contains the other stack
    @ZenCodeType.Method
    ...
    ///
    /// @return `true` if the chemicals stacks are equal, `false` otherwise.
    ///
    ...
    /// Casts this chemical stack to a generic [ChemicalStackIngredient] for use in recipes that support any chemical type as an input.
    ///
