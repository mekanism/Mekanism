...
public class BlockMetallurgicInfuser extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockMetallurgicInfuser(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
