...
public class BlockFluidicPlenisher extends BlockMekanism implements IBlockElectric, IHasModel, IHasGui<TileEntityFluidicPlenisher>, ISupportsUpgrades, IStateFacing,
      IStateActive, IHasInventory, IHasSecurity, ISupportsRedstone, IHasTileEntity<TileEntityFluidicPlenisher>, ISupportsComparator, IStateFluidLoggable, IHasDescription {
    ...
    @Override
    public ContainerTypeRegistryObject<MekanismTileContainer<TileEntityFluidicPlenisher>> getContainerType() {
