...
public class BlockFluidicPlenisher extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockFluidicPlenisher(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
