...
public class BlockSeismicVibrator extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockSeismicVibrator(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
