...
public class BlockSeismicVibrator extends BlockMekanismContainer implements IBlockMekanism, IBlockElectric, IHasModel, IBlockActiveTextured {

    private final String name;

    public BlockSeismicVibrator(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
