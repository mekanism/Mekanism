...
public class BlockChargepad extends BlockMekanismContainer implements IBlockElectric, IHasModel, IRotatableBlock, IBlockDescriptive {

    private static final AxisAlignedBB CHARGEPAD_BOUNDS = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.06F, 1.0F);

    private final String name;

    public BlockChargepad(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
