...
public class BlockChargepad extends BlockMekanismContainer implements IBlockMekanism {
    ...
    public BlockChargepad(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
