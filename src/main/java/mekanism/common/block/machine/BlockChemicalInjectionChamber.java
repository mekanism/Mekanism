...
public class BlockChemicalInjectionChamber extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockChemicalInjectionChamber(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
