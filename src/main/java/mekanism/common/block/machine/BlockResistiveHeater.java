...
public class BlockResistiveHeater extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockResistiveHeater(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
