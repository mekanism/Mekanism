...
public class BlockPressurizedReactionChamber extends BlockMekanismContainer implements IBlockElectric, IHasModel, IBlockActiveTextured, IRotatableBlock,
      IBlockDescriptive, IHasGui, ISupportsUpgrades, IStateFacing, IStateActive {
