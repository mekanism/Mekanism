...
public class BlockPressurizedReactionChamber extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockPressurizedReactionChamber(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
