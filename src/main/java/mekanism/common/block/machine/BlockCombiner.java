...
public class BlockCombiner extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockCombiner(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
