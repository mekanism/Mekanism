...
public class BlockChemicalOxidizer extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockChemicalOxidizer(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
