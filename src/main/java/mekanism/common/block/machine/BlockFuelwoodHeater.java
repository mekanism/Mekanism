...
public class BlockFuelwoodHeater extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockFuelwoodHeater(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
