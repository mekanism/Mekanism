...
public class BlockChemicalInfuser extends BlockMekanismContainer implements IBlockElectric, IHasModel, IHasGui<TileEntityChemicalInfuser>, ISupportsUpgrades, IStateFacing, IStateActive,
      IHasInventory, IHasSecurity, IHasTileEntity<TileEntityChemicalInfuser>, IBlockSound, ISupportsRedstone, IBlockDisableable, ISupportsComparator {
    ...
    public BlockChemicalInfuser() {
        ...
        setRegistryName(new ResourceLocation(Mekanism.MODID, "chemical_infuser"));
    }
    ...
    @Nullable
    @Override
    public Class<? extends TileEntityChemicalInfuser> getTileClass() {
        return TileEntityChemicalInfuser.class;
    }
