...
public class BlockChemicalInfuser extends BlockMekanismContainer implements IBlockElectric, IHasModel, IBlockDescriptive, IHasGui, ISupportsUpgrades, IStateFacing,
      IStateActive {
    ...
    protected ItemStack getDropItem(@Nonnull IBlockState state, @Nonnull IBlockAccess world, @Nonnull BlockPos pos) {
        TileEntityChemicalInfuser tile = (TileEntityChemicalInfuser) world.getTileEntity(pos);
