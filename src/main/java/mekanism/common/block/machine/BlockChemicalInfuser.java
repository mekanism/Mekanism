...
public class BlockChemicalInfuser extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockChemicalInfuser(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
