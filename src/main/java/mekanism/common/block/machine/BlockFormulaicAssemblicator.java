...
public class BlockFormulaicAssemblicator extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IBlockActiveTextured, IRotatableBlock,
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityFormulaicAssemblicator) MekanismUtils.getTileEntitySafe(world, pos));
    }
