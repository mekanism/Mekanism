...
public class BlockPersonalChest extends BlockMekanismContainer implements IBlockMekanism, IBlockElectric, IHasModel, IRotatableBlock {

    private final String name;

    public BlockPersonalChest(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
