...
public class BlockPersonalChest extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockPersonalChest(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
