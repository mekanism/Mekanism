...
public class BlockEnrichmentChamber extends BlockMekanism implements IBlockElectric, ISupportsUpgrades, IHasGui<TileEntityEnrichmentChamber>, IStateFacing, IStateActive,
    ...
    public SoundEvent getSoundEvent() {
        return HolidayManager.filterSound(MekanismSounds.ENRICHMENT_CHAMBER).getSoundEvent();
    }

    @Override
    public ContainerTypeRegistryObject<MekanismTileContainer<TileEntityEnrichmentChamber>> getContainerType() {
