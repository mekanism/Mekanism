...
public class BlockChemicalCrystallizer extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IHasModel, IBlockActiveTextured, IRotatableBlock,
      IBlockDescriptive, IHasGui, IStateFacing, IStateActive {
    ...
    public BlockChemicalCrystallizer() {
        ...
        this.name = "chemical_crystallizer";
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityChemicalCrystallizer) MekanismUtils.getTileEntitySafe(world, pos));
    }
