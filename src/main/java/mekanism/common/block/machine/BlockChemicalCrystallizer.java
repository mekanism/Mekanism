...
public class BlockChemicalCrystallizer extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockChemicalCrystallizer(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
