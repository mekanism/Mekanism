...
public class BlockQuantumEntangloporter extends BlockMekanismContainer implements IBlockMekanism, IBlockElectric, IRotatableBlock {

    private final String name;

    public BlockQuantumEntangloporter(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
