...
public class BlockQuantumEntangloporter extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockQuantumEntangloporter(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
