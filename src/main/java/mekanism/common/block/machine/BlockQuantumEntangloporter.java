...
public class BlockQuantumEntangloporter extends BlockMekanismContainer implements IBlockElectric, IRotatableBlock, IBlockDescriptive, IHasGui, ISupportsUpgrades,
    ...
    public BlockQuantumEntangloporter() {
        ...
        this.name = "quantum_entangloporter";
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityQuantumEntangloporter) MekanismUtils.getTileEntitySafe(world, pos));
    }
