...
public class BlockChemicalDissolutionChamber extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IHasModel, IHasGui<TileEntityChemicalDissolutionChamber>, IStateFacing, IStateActive,
      IHasInventory, IHasSecurity, IHasTileEntity<TileEntityChemicalDissolutionChamber>, IBlockSound, ISupportsRedstone, IBlockDisableable, ISupportsComparator {
    ...
    public double getUsage() {
        return MekanismConfig.usage.chemicalDissolutionChamber.get();
    }
