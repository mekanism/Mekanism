...
public class BlockChemicalDissolutionChamber extends BlockMekanismContainer implements IBlockMekanism, IBlockElectric, ISupportsUpgrades, IHasModel, IBlockActiveTextured,
      IRotatableBlock {

    private final String name;

    public BlockChemicalDissolutionChamber(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
