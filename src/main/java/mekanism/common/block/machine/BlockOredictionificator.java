...
public class BlockOredictionificator extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockOredictionificator(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
