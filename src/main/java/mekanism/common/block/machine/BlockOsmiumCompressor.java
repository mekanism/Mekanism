...
public class BlockOsmiumCompressor extends BlockMekanism implements IBlockElectric, ISupportsUpgrades, IHasGui<TileEntityOsmiumCompressor>, IStateFacing, IStateActive,
      IHasFactoryType, IHasInventory, IHasSecurity, IHasTileEntity<TileEntityOsmiumCompressor>, IBlockSound, ISupportsRedstone, ISupportsComparator, IHasDescription {

    public static final SoundEvent SOUND_EVENT = new SoundEvent(Mekanism.rl("tile.machine.compressor"));
    ...
    public FactoryType getFactoryType() {
        return FactoryType.COMPRESSING;
    }
    ...
    public double getUsage() {
        return MekanismConfig.usage.osmiumCompressor.get();
    }
    ...
    @Override
    public INamedContainerProvider getProvider(TileEntityOsmiumCompressor tile) {
        return new ContainerProvider(getNameTextComponent(), (i, inv, player) -> new OsmiumCompressorContainer(i, inv, tile));
    }
    ...
    public ILangEntry getDescription() {
        return MekanismLang.DESCRIPTION_OSMIUM_COMPRESSOR;
    }
}