...
public class BlockOsmiumCompressor extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockOsmiumCompressor(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
