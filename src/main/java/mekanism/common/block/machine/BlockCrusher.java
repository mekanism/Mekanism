...
public class BlockCrusher extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IBlockActiveTextured, IRotatableBlock, IBlockDescriptive, IHasGui,
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityCrusher) MekanismUtils.getTileEntitySafe(world, pos));
    }
