...
public class BlockPurificationChamber extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockPurificationChamber(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
