...
public class BlockElectrolyticSeparator extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockElectrolyticSeparator(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
