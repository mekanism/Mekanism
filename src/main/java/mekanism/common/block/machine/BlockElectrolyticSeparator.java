...
public class BlockElectrolyticSeparator extends BlockMekanismContainer implements IBlockElectric, IHasModel, IBlockActiveTextured, IRotatableBlock, IBlockDescriptive,
    ...
    public BlockElectrolyticSeparator() {
        ...
        this.name = "electrolytic_separator";
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityElectrolyticSeparator) MekanismUtils.getTileEntitySafe(world, pos));
    }
