...
public class BlockElectrolyticSeparator extends BlockMekanismContainer implements IBlockElectric, IHasModel, IBlockDescriptive, IHasGui, ISupportsUpgrades, IStateFacing,
      IStateActive {
