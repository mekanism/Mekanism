...
public class BlockRotaryCondensentrator extends BlockMekanismContainer implements IBlockElectric, IHasModel, IRotatableBlock, IBlockDescriptive, IHasGui,
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityRotaryCondensentrator) MekanismUtils.getTileEntitySafe(world, pos));
    }
