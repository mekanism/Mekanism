...
public class BlockRotaryCondensentrator extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockRotaryCondensentrator(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
