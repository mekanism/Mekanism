...
public class BlockDigitalMiner extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockDigitalMiner(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
