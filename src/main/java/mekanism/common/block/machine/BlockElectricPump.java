...
public class BlockElectricPump extends BlockMekanismContainer implements IBlockElectric, IHasModel, IRotatableBlock, IBlockDescriptive {

    private final String name;

    public BlockElectricPump(String name) {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
