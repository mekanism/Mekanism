...
public class BlockEnergizedSmelter extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IHasGui<TileEntityEnergizedSmelter>, IStateFacing, IStateActive, IHasFactoryType,
      IHasInventory, IHasSecurity, IHasTileEntity<TileEntityEnergizedSmelter>, IBlockSound, ISupportsRedstone, IBlockDisableable, ISupportsComparator {

    public static final SoundEvent SOUND_EVENT = new SoundEvent(new ResourceLocation(Mekanism.MODID, "tile.machine.smelter"));
