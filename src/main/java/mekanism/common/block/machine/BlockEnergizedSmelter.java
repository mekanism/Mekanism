...
public class BlockEnergizedSmelter extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockEnergizedSmelter(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
