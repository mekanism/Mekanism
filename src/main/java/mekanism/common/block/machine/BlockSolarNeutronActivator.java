...
public class BlockSolarNeutronActivator extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockSolarNeutronActivator(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
