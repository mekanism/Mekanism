...
public class BlockPrecisionSawmill extends BlockMekanismContainer implements IBlockMekanism {

    private final Predicate<EnumFacing> facingPredicate;
    private final String name;

    public BlockPrecisionSawmill(String name, Predicate<EnumFacing> facingPredicate) {
        super(Material.IRON);
