...
public class BlockPrecisionSawmill extends BlockMekanismContainer implements IBlockElectric, ISupportsUpgrades, IBlockDescriptive, IHasGui, IStateFacing, IStateActive {
    ...
    protected ItemStack getDropItem(@Nonnull IBlockState state, @Nonnull IBlockAccess world, @Nonnull BlockPos pos) {
        TileEntityPrecisionSawmill tile = (TileEntityPrecisionSawmill) world.getTileEntity(pos);
        ...
        securityItem.setOwnerUUID(itemStack, ((ISecurityTile) tile).getSecurity().getOwnerUUID());
        securityItem.setSecurity(itemStack, ((ISecurityTile) tile).getSecurity().getMode());
        //Upgrades
        ...
        if (tile.inventory.size() > 0) {
            ...
            inventory.setInventory(((ISustainedInventory) tile).getInventory(), itemStack);
        }
        //Energy
