...
public class BlockLogisticalSorter extends BlockMekanismContainer implements IHasModel, IBlockDescriptive, IHasGui, ISupportsUpgrades, IStateFacing, IStateActive {
