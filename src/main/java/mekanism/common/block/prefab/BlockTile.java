...
public class BlockTile<TILE extends TileEntityMekanism, TYPE extends BlockTypeTile<TILE>> extends BlockBase<TYPE> implements IHasTileEntity<TILE> {
    ...
    //TODO - 26.3: Re-evaluate usages of this and maybe decide to inline properties to call sites?
    ...
    public boolean shouldRedstoneWireConnectTo(BlockState state, BlockGetter world, BlockPos pos, @Nullable Direction side) {
        return type.has(AttributeRedstoneEmitter.class) || super.shouldRedstoneWireConnectTo(state, world, pos, side);
    }
