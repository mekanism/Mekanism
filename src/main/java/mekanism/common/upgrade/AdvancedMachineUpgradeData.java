...
public class AdvancedMachineUpgradeData extends MachineUpgradeData {
    ...
    public AdvancedMachineUpgradeData(boolean redstone, RedstoneControl controlType, IEnergyContainer energyContainer, int operatingTicks, long usedSoFar, IGasTank stored,
    ...
    public AdvancedMachineUpgradeData(boolean redstone, RedstoneControl controlType, IEnergyContainer energyContainer, int[] progress, long[] usedSoFar, IGasTank stored,
