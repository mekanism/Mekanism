...
public class AdvancedMachineUpgradeData extends MachineUpgradeData {
    ...
    public AdvancedMachineUpgradeData(boolean redstone, RedstoneControl controlType, IEnergyContainer energyContainer, int operatingTicks, IGasTank stored,
    ...
    public AdvancedMachineUpgradeData(boolean redstone, RedstoneControl controlType, IEnergyContainer energyContainer, int[] progress, IGasTank stored,
