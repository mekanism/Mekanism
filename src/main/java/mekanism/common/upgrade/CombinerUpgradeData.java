...
public class CombinerUpgradeData implements IUpgradeData {
    ...
    public CombinerUpgradeData(boolean redstone, RedstoneControl controlType, double electricityStored, int operatingTicks, EnergyInventorySlot energySlot,
        ...
        this(redstone, controlType, electricityStored, new int[]{operatingTicks},
              energySlot, extraSlot, Collections.singletonList(inputSlot), Collections.singletonList(outputSlot), false, ItemStack.EMPTY, ItemStack.EMPTY, components);
    }
