...
{
	public static String[] Minecraft_timer = new String[] {"timer", "field_71428_T"};
	public static String[] GuiContainer_xSize = new String[] {"xSize", "field_146999_f"};
	public static String[] GuiContainer_ySize = new String[] {"ySize", "field_147000_g"};
