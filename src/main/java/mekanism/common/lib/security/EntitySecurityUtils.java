...
public class EntitySecurityUtils implements IEntitySecurityUtils {
    ...
    private static final EntityCapability<ISecurityObject, @Nullable Void> SECURITY_CAPABILITY = EntityCapability.createVoid(Capabilities.SECURITY_OBJECT_NAME, ISecurityObject.class);
    ...
    @Override
    public EntityCapability<IOwnerObject, @Nullable Void> ownerCapability() {
        return OWNER_CAPABILITY;
    }

    @Override
    public EntityCapability<ISecurityObject, @Nullable Void> securityCapability() {
