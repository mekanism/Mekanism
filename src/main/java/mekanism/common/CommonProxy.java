...
public class CommonProxy implements IGuiProvider
{
	...
	public void loadConfiguration()
	{
		...
		recipes.enableOsmiumBlock = Mekanism.configuration.get("Recipes","enableOsmiumBlock", true).getBoolean();
		recipes.enableBronzeBlock = Mekanism.configuration.get("Recipes","enableBronzeBlock", true).getBoolean();
		recipes.enableRefinedObsidianBlock = Mekanism.configuration.get("Recipes","enableRefinedObsidianBlock", true).getBoolean();
		recipes.enableCharcoalBlock = Mekanism.configuration.get("Recipes","enableCharcoalBlock", true).getBoolean();
		recipes.enableRefinedGlowstoneBlock = Mekanism.configuration.get("Recipes","enableSteelBlock", true).getBoolean();
		recipes.enableSteelBlock = Mekanism.configuration.get("Recipes","enableSteelBlock", true).getBoolean();
		recipes.enableCopperBlock = Mekanism.configuration.get("Recipes","enableCopperBlock", true).getBoolean();
		recipes.enableTinBlock = Mekanism.configuration.get("Recipes","enableTinBlock", true).getBoolean();
		recipes.enableBins = Mekanism.configuration.get("Recipes","enableBins", true).getBoolean();
		recipes.enableTeleporterFrame = Mekanism.configuration.get("Recipes","enableTeleporterFrame", true).getBoolean();
		recipes.enableSteelCasing = Mekanism.configuration.get("Recipes","enableSteelCasing", true).getBoolean();
		recipes.enableDynamicTank = Mekanism.configuration.get("Recipes","enableDynamicTank", true).getBoolean();
		recipes.enableDynamicGlass = Mekanism.configuration.get("Recipes","enableDynamicGlass", true).getBoolean();
		recipes.enableDynamicValve = Mekanism.configuration.get("Recipes","enableDynamicValve", true).getBoolean();
		recipes.enableThermalEvaporationController = Mekanism.configuration.get("Recipes","enableThermalEvaporationController", true).getBoolean();
		recipes.enableThermalEvaporationValve = Mekanism.configuration.get("Recipes","enableThermalEvaporationValve", true).getBoolean();
		recipes.enableThermalEvaporationBlock = Mekanism.configuration.get("Recipes","enableThermalEvaporationBlock", true).getBoolean();
		recipes.enableInductionCasing = Mekanism.configuration.get("Recipes","enableInductionCasing", true).getBoolean();
		recipes.enableInductionPorts = Mekanism.configuration.get("Recipes","enableInductionPorts", true).getBoolean();
		recipes.enableInductionCells = Mekanism.configuration.get("Recipes","enableInductionCells", true).getBoolean();
		recipes.enableInductionProviders = Mekanism.configuration.get("Recipes","enableInductionProviders", true).getBoolean();
		recipes.enableSuperheatingElement = Mekanism.configuration.get("Recipes","enableSuperheatingElement", true).getBoolean();
		recipes.enablePressureDispenser = Mekanism.configuration.get("Recipes","enablePressureDispenser", true).getBoolean();
		recipes.enableBoilerCasing = Mekanism.configuration.get("Recipes","enableBoilerCasing", true).getBoolean();
		recipes.enableBoilerValve = Mekanism.configuration.get("Recipes","enableBoilerValve", true).getBoolean();
		recipes.enableSecurityDesk = Mekanism.configuration.get("Recipes","enableSecurityDesk", true).getBoolean();
		recipes.enableEnrichmentChamber = Mekanism.configuration.get("Recipes","enableEnrichmentChamber", true).getBoolean();
		recipes.enableOsmiumCompressor = Mekanism.configuration.get("Recipes","enableOsmiumCompressor", true).getBoolean();
		recipes.enableCombiner = Mekanism.configuration.get("Recipes","enableCombiner", true).getBoolean();
		recipes.enableCrusher = Mekanism.configuration.get("Recipes","enableCrusher", true).getBoolean();
		recipes.enableDigitalMiner = Mekanism.configuration.get("Recipes","enableDigitalMiner", true).getBoolean();
		recipes.enableFactories = Mekanism.configuration.get("Recipes","enableFactories", true).getBoolean();
		recipes.enableMetallurgicInfuser = Mekanism.configuration.get("Recipes","enableMetallurgicInfuser", true).getBoolean();
		recipes.enablePurificationChamber = Mekanism.configuration.get("Recipes","enablePurificationChamber", true).getBoolean();
		recipes.enableEnergizedSmelter = Mekanism.configuration.get("Recipes","enableEnergizedSmelter", true).getBoolean();
		recipes.enableTeleporterBlock = Mekanism.configuration.get("Recipes","enableTeleporterBlock", true).getBoolean();
		recipes.enableElectricPump = Mekanism.configuration.get("Recipes","enableElectricPump", true).getBoolean();
		recipes.enablePersonalChest = Mekanism.configuration.get("Recipes","enablePersonalChest", true).getBoolean();
		recipes.enableChargePad = Mekanism.configuration.get("Recipes","enableChargePad", true).getBoolean();
		recipes.enableLogisticalSorter = Mekanism.configuration.get("Recipes","enableLogisticalSorter", true).getBoolean();
		recipes.enableRotaryCondensentrator = Mekanism.configuration.get("Recipes","enableRotaryCondensentrator", true).getBoolean();
		recipes.enableChemicalOxidiser = Mekanism.configuration.get("Recipes","enableChemicalOxidiser", true).getBoolean();
		recipes.enableChemicalInfuser = Mekanism.configuration.get("Recipes","enableChemicalInfuser", true).getBoolean();
		recipes.enableChemicalInjection = Mekanism.configuration.get("Recipes","enableChemicalInjection", true).getBoolean();
		recipes.enableElectrolyticSeparator = Mekanism.configuration.get("Recipes","enableElectrolyticSeparator", true).getBoolean();
		recipes.enableElectroliticCore = Mekanism.configuration.get("Recipes","enableElectroliticCore", true).getBoolean();
		recipes.enableCardboardBox = Mekanism.configuration.get("Recipes","enableCardboardBox", true).getBoolean();
		recipes.enableSawdusttoPaper = Mekanism.configuration.get("Recipes","enableSawdusttoPaper", true).getBoolean();
		recipes.enablePrecisionSawmill = Mekanism.configuration.get("Recipes","enablePrecisionSawmill", true).getBoolean();
		recipes.enableChemicaDissolution = Mekanism.configuration.get("Recipes","enableChemicaDissolution", true).getBoolean();
		recipes.enableChemicalWasher = Mekanism.configuration.get("Recipes","enableChemicalWasher", true).getBoolean();
		recipes.enableChemicalCrystallizer = Mekanism.configuration.get("Recipes","enableChemicalCrystallizer", true).getBoolean();
		recipes.enableSeismicVibrator = Mekanism.configuration.get("Recipes","enableSeismicVibrator", true).getBoolean();
		recipes.enablePressurizedReactorChamber = Mekanism.configuration.get("Recipes","enablePressurizedReactorChamber", true).getBoolean();
		recipes.enableLiquidTanks = Mekanism.configuration.get("Recipes","enableLiquidTanks", true).getBoolean();
		recipes.enableFluidPlenisher = Mekanism.configuration.get("Recipes","enableFluidPlenisher", true).getBoolean();
		recipes.enableLaser = Mekanism.configuration.get("Recipes","enableLaser", true).getBoolean();
		recipes.enableLaserAmplifyier = Mekanism.configuration.get("Recipes","enableLaserAmplifyier", true).getBoolean();
		recipes.enableLaserTractorBeam = Mekanism.configuration.get("Recipes","enableLaserTractorBeam", true).getBoolean();
		recipes.enableEntangloporter = Mekanism.configuration.get("Recipes","enableEntangloporter", true).getBoolean();
		recipes.enableSolarNeutronActivator = Mekanism.configuration.get("Recipes","enableSolarNeutronActivator", true).getBoolean();
		recipes.enableOredictionator = Mekanism.configuration.get("Recipes","enableOredictionator", true).getBoolean();
		recipes.enableResistiveHeater = Mekanism.configuration.get("Recipes","enableResistiveHeater", true).getBoolean();
		recipes.enableFormulaicAssembler = Mekanism.configuration.get("Recipes","enableFormulaicAssembler", true).getBoolean();
		recipes.enableFuelwoodHeater = Mekanism.configuration.get("Recipes","enableFuelwoodHeater", true).getBoolean();
		recipes.enableEnergyCubes = Mekanism.configuration.get("Recipes","enableEnergyCubes", true).getBoolean();
		recipes.enableObsidianTNT = Mekanism.configuration.get("Recipes","enableObsidianTNT", true).getBoolean();
		recipes.enableGasTanks = Mekanism.configuration.get("Recipes","enableGasTanks", true).getBoolean();
		recipes.enablePlasticBlocks = Mekanism.configuration.get("Recipes","enablePlasticBlocks", true).getBoolean();
		recipes.enableSaltBlock = Mekanism.configuration.get("Recipes","enableSaltBlock", true).getBoolean();
		recipes.enableUniversalCables = Mekanism.configuration.get("Recipes","enableUniversalCables", true).getBoolean();
		recipes.enableMechanicalPipes = Mekanism.configuration.get("Recipes","enableMechanicalPipes", true).getBoolean();
		recipes.enablePressurizedTubes = Mekanism.configuration.get("Recipes","enablePressurizedTubes", true).getBoolean();
		recipes.enableLogisticalTransporter = Mekanism.configuration.get("Recipes","enableLogisticalTransporter", true).getBoolean();
		recipes.enableThermoConductors = Mekanism.configuration.get("Recipes","enableThermoConductors", true).getBoolean();
		recipes.enableElectricBow = Mekanism.configuration.get("Recipes","enableElectricBow", true).getBoolean();
		recipes.enableEnergyTablet = Mekanism.configuration.get("Recipes","enableEnergyTablet", true).getBoolean();
		recipes.enableMachineUpgrades = Mekanism.configuration.get("Recipes","enableMachineUpgrades", true).getBoolean();
		recipes.enableRobit = Mekanism.configuration.get("Recipes","enableRobit", true).getBoolean();
		recipes.enableAtomicDisassembler = Mekanism.configuration.get("Recipes","enableAtomicDisassembler", true).getBoolean();
		recipes.enableCircuits = Mekanism.configuration.get("Recipes","enableCircuits", true).getBoolean();
		recipes.enablePortableTeleporter = Mekanism.configuration.get("Recipes","enablePortableTeleporter", true).getBoolean();
		recipes.enableTeleporterCore = Mekanism.configuration.get("Recipes","enableTeleporterCore", true).getBoolean();
		recipes.enableConfigurator = Mekanism.configuration.get("Recipes","enableConfigurator", true).getBoolean();
		recipes.enableNetworkReader = Mekanism.configuration.get("Recipes","enableNetworkReader", true).getBoolean();
		recipes.enableWalkieTalkie = Mekanism.configuration.get("Recipes","enableWalkieTalkie", true).getBoolean();
		recipes.enableJetpacks = Mekanism.configuration.get("Recipes","enableJetpacks", true).getBoolean();
		recipes.enableScubaSet = Mekanism.configuration.get("Recipes","enableScubaSet", true).getBoolean();
		recipes.enableFreeRunners = Mekanism.configuration.get("Recipes","enableFreeRunners", true).getBoolean();
		recipes.enableConfigurationCard = Mekanism.configuration.get("Recipes","enableConfigurationCard", true).getBoolean();
		recipes.enableCraftingFormula = Mekanism.configuration.get("Recipes","enableCraftingFormula", true).getBoolean();
		recipes.enableSeismicReader = Mekanism.configuration.get("Recipes","enableSeismicReader", true).getBoolean();
		recipes.enableHDPEParts = Mekanism.configuration.get("Recipes","enableHDPEParts", true).getBoolean();
