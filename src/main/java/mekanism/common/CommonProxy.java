...
public class CommonProxy implements IGuiProvider
{
	...
	public void loadConfiguration()
	{
		...
		general.digitalMinerMaxRadius = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "DigitalMinerMaxRadius", 32, "Select range from 1 to 32", 1, 32).getInt();
