...
public class SawmillRecipeSerializer<T extends SawmillIRecipe> extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
    ...
    public interface IFactory<T extends SawmillIRecipe> {
