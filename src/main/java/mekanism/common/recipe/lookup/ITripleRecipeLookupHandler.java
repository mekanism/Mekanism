...
/// Helper expansion of [IRecipeLookupHandler] for easily implementing contains and find recipe lookups for recipes that takes three inputs.
public interface ITripleRecipeLookupHandler<HOLDER_A, INPUT_A extends TypedInstance<HOLDER_A>, HOLDER_B, INPUT_B extends TypedInstance<HOLDER_B>,
    ...
    ///
    /// @see TripleInputRecipeCache#containsInputABC(Level, TypedInstance, TypedInstance, TypedInstance)
    /// @see TripleInputRecipeCache#containsInputBAC(Level, TypedInstance, TypedInstance, TypedInstance)
    /// @see TripleInputRecipeCache#containsInputCAB(Level, TypedInstance, TypedInstance, TypedInstance)
    /// @see #containsRecipeBAC(TypedInstance, TypedInstance, TypedInstance)
    /// @see #containsRecipeCAB(TypedInstance, TypedInstance, TypedInstance)
    ...
    /// @return `true` if there is a match, `false` if there isn't.
    ///
    /// @apiNote See [TripleInputRecipeCache#containsInputABC(Level, TypedInstance, TypedInstance, TypedInstance)],
    /// [TripleInputRecipeCache#containsInputBAC(Level, TypedInstance, TypedInstance, TypedInstance)], and
    /// [TripleInputRecipeCache#containsInputCAB(Level, TypedInstance, TypedInstance, TypedInstance)] for more details about when this method should be called versus
    /// when [#containsRecipeABC(TypedInstance, TypedInstance, TypedInstance)] or [#containsRecipeCAB(TypedInstance, TypedInstance, TypedInstance)] should be
    /// called.
    ...
    /// [TripleInputRecipeCache#containsInputBAC(Level, TypedInstance, TypedInstance, TypedInstance)], and
    /// [TripleInputRecipeCache#containsInputCAB(Level, TypedInstance, TypedInstance, TypedInstance)] for more details about when this method should be called versus
    /// when [#containsRecipeABC(TypedInstance, TypedInstance, TypedInstance)] or [#containsRecipeBAC(TypedInstance, TypedInstance, TypedInstance)] should be
    /// called.
    ...
    /// Helper interface to make the generics that we have to pass to [ITripleRecipeLookupHandler] not as messy.
