...
public class InputRecipeCache {
    ...
    public static class SingleChemical<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>, RECIPE extends MekanismRecipe & Predicate<STACK>>
          extends SingleInputRecipeCache<STACK, IChemicalStackIngredient<CHEMICAL, STACK>, RECIPE, ChemicalInputCache<CHEMICAL, STACK, RECIPE>> {

        public SingleChemical(MekanismRecipeType<RECIPE, ?> recipeType, Function<RECIPE, IChemicalStackIngredient<CHEMICAL, STACK>> inputExtractor) {
    ...
    public static class ItemChemical<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>, RECIPE extends MekanismRecipe &
          BiPredicate<ItemStack, STACK>> extends DoubleInputRecipeCache<ItemStack, ItemStackIngredient, STACK, IChemicalStackIngredient<CHEMICAL, STACK>, RECIPE,
        ...
        public ItemChemical(MekanismRecipeType<RECIPE, ?> recipeType, Function<RECIPE, ItemStackIngredient> inputAExtractor,
              Function<RECIPE, IChemicalStackIngredient<CHEMICAL, STACK>> inputBExtractor) {
    ...
    public static class FluidChemical<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>, RECIPE extends MekanismRecipe &
          BiPredicate<FluidStack, STACK>> extends DoubleInputRecipeCache<FluidStack, FluidStackIngredient, STACK, IChemicalStackIngredient<CHEMICAL, STACK>, RECIPE,
    ...
    public static class EitherSideChemical<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>,
          RECIPE extends ChemicalChemicalToChemicalRecipe<CHEMICAL, STACK, ? extends IChemicalStackIngredient<CHEMICAL, STACK>>>
          extends EitherSideInputRecipeCache<STACK, IChemicalStackIngredient<CHEMICAL, STACK>, RECIPE, ChemicalInputCache<CHEMICAL, STACK, RECIPE>> {
    ...
    public static class ItemFluidChemical<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>, RECIPE extends MekanismRecipe &
          ...
          IChemicalStackIngredient<CHEMICAL, STACK>, RECIPE, ItemInputCache<RECIPE>, FluidInputCache<RECIPE>, ChemicalInputCache<CHEMICAL, STACK, RECIPE>> {

        public ItemFluidChemical(MekanismRecipeType<RECIPE, ?> recipeType, Function<RECIPE, ItemStackIngredient> inputAExtractor,
              Function<RECIPE, FluidStackIngredient> inputBExtractor, Function<RECIPE, IChemicalStackIngredient<CHEMICAL, STACK>> inputCExtractor) {
