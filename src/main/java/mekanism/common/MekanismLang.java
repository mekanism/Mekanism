...
public enum MekanismLang implements ILangEntry {
    ...
    STORED_CHEMICALS("tooltip", "stored.chemical"),
    STORED_FLUID("tooltip", "stored.fluid"),
    ...
    TOOLTIP_MODULE_TYPE("tooltip", "module.type"),
    ...
    MODULE_INSTALLED_NONE("module", "installed.none"),
    MODULE_INSTALLED_LIST("module", "installed.list"),
