...
public enum MekanismLang implements ILangEntry {
    ...
    //Advancements
    ADVANCEMENT_ROOT("advancement", "root"),
    ADVANCEMENT_MATERIALS("advancement", "materials"),
    ADVANCEMENT_FLUIDTANK("advancement", "fluidtank"),
    ADVANCEMENT_CHEMICALTANK("advancement", "chemicaltank"),
    ADVANCEMENT_FULLCANTEEN("advancement", "fullcanteen"),
    ADVANCEMENT_METALLURGICINFUSER("advancement", "metallurgicinfuser"),
    ADVANCEMENT_STEELINGOT("advancement", "steelingot"),
    ADVANCEMENT_STEELCASING("advancement", "steelcasing"),
    ADVANCEMENT_INFUSED_ALLOY("advancement", "infused_alloy"),
    ADVANCEMENT_REINFORCED_ALLOY("advancement", "reinforced_alloy"),
    ADVANCEMENT_ATOMIC_ALLOY("advancement", "atomic_alloy"),
    ADVANCEMENT_PLUTONIUM("advancement", "plutonium"),
    ADVANCEMENT_SPS("advancement", "sps"),
    ADVANCEMENT_ANTIMATTER("advancement", "antimatter"),
    ADVANCEMENT_NUCLEOSYNTHESIZER("advancement", "nucleosynthesizer"),
    ADVANCEMENT_POLONIUM("advancement", "polonium"),
    ADVANCEMENT_QIODRIVEARRAY("advancement", "qiodrivearray"),
    ADVANCEMENT_BASICQIODRIVE("advancement", "basicqiodrive"),
    ADVANCEMENT_ADVANCEDQIODRIVE("advancement", "advancedqiodrive"),
    ADVANCEMENT_ELITEQIODRIVE("advancement", "eliteqiodrive"),
    ADVANCEMENT_ULTIMATEQIODRIVE("advancement", "ultimateqiodrive"),
    ADVANCEMENT_QIODASHBOARD("advancement", "qiodashboard"),
    ADVANCEMENT_PORTABLEQIODASHBOARD("advancement", "portableqiodashboard"),
    ADVANCEMENT_TELEPORTCORE("advancement", "teleportcore"),
    ADVANCEMENT_TELEPORTER("advancement", "teleporter"),
    ADVANCEMENT_PORTABLETELEPORTER("advancement", "portableteleporter"),
    ADVANCEMENT_QUANTUMENTANGLOPORTER("advancement", "quantumentangloporter"),
    ADVANCEMENT_BASIC_CONTROL("advancement", "basic_control"),
    ADVANCEMENT_ADVANCED_CONTROL("advancement", "advanced_control"),
    ADVANCEMENT_ELITE_CONTROL("advancement", "elite_control"),
    ADVANCEMENT_ULTIMATE_CONTROL("advancement", "ultimate_control"),
    ADVANCEMENT_ROBIT("advancement", "robit"),
    ADVANCEMENT_DISASSEMBLER("advancement", "disassembler"),
    ADVANCEMENT_MEKASUIT("advancement", "mekasuit"),
    ADVANCEMENT_UPGRADEDMEKASUIT("advancement", "upgradedmekasuit"),
    ;
