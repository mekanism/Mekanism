...
public enum MekanismLang implements ILangEntry {
    ...
    //Advancements
    ADVANCEMENT_ROOT("advancements", "root"),
    ADVANCEMENT_MATERIALS("advancements", "materials"),
    ADVANCEMENT_FLUIDTANK("advancements", "fluidtank"),
    ADVANCEMENT_CHEMICALTANK("advancements", "chemicaltank"),
    ADVANCEMENT_FULLCANTEEN("advancements", "fullcanteen"),
    ADVANCEMENT_METALLURGICINFUSER("advancements", "metallurgicinfuser"),
    ADVANCEMENT_STEELINGOT("advancements", "steelingot"),
    ADVANCEMENT_STEELCASING("advancements", "steelcasing"),
    ADVANCEMENT_INFUSED_ALLOY("advancements", "infused_alloy"),
    ADVANCEMENT_REINFORCED_ALLOY("advancements", "reinforced_alloy"),
    ADVANCEMENT_ATOMIC_ALLOY("advancements", "atomic_alloy"),
    ADVANCEMENT_PLUTONIUM("advancements", "plutonium"),
    ADVANCEMENT_SPS("advancements", "sps"),
    ADVANCEMENT_ANTIMATTER("advancements", "antimatter"),
    ADVANCEMENT_NUCLEOSYNTHESIZER("advancements", "nucleosynthesizer"),
    ADVANCEMENT_POLONIUM("advancements", "polonium"),
    ADVANCEMENT_QIODRIVEARRAY("advancements", "qiodrivearray"),
    ADVANCEMENT_BASICQIODRIVE("advancements", "basicqiodrive"),
    ADVANCEMENT_ADVANCEDQIODRIVE("advancements", "advancedqiodrive"),
    ADVANCEMENT_ELITEQIODRIVE("advancements", "eliteqiodrive"),
    ADVANCEMENT_ULTIMATEQIODRIVE("advancements", "ultimateqiodrive"),
    ADVANCEMENT_QIODASHBOARD("advancements", "qiodashboard"),
    ADVANCEMENT_PORTABLEQIODASHBOARD("advancements", "portableqiodashboard"),
    ADVANCEMENT_TELEPORTCORE("advancements", "teleportcore"),
    ADVANCEMENT_TELEPORTER("advancements", "teleporter"),
    ADVANCEMENT_PORTABLETELEPORTER("advancements", "portableteleporter"),
    ADVANCEMENT_QUANTUMENTANGLOPORTER("advancements", "quantumentangloporter"),
    ADVANCEMENT_BASIC_CONTROL("advancements", "basic_control"),
    ADVANCEMENT_ADVANCED_CONTROL("advancements", "advanced_control"),
    ADVANCEMENT_ELITE_CONTROL("advancements", "elite_control"),
    ADVANCEMENT_ULTIMATE_CONTROL("advancements", "ultimate_control"),
    ADVANCEMENT_ROBIT("advancements", "robit"),
    ADVANCEMENT_DISASSEMBLER("advancements", "disassembler"),
    ADVANCEMENT_MEKASUIT("advancements", "mekasuit"),
    ADVANCEMENT_UPGRADEDMEKASUIT("advancements", "upgradedmekasuit"),
    ;
