...
public class TierConfig
{
	...
	{
		EnergyCubeMaxEnergy = new DoubleOption(baseConfig, "tier", tier.getSimpleName()+"EnergyCubeMaxEnergy", Tier.EnergyCubeTier.values()[tier.ordinal()].baseMaxEnergy);
		...
		if (tier != Tier.BaseTier.CREATIVE)
		{
			...
			InductionProviderOutput = new DoubleOption(baseConfig, "tier", tier.getSimpleName() + "InductionProviderOutput", Tier.InductionProviderTier.values()[tier.ordinal()].baseOutput);
			CableCapacity = new IntOption(baseConfig, "tier", tier.getSimpleName() + "CableCapacity", Tier.CableTier.values()[tier.ordinal()].baseCapacity);
			PipeCapacity = new IntOption(baseConfig, "tier", tier.getSimpleName() + "PipeCapacity", Tier.PipeTier.values()[tier.ordinal()].baseCapacity);
			PipePullAmount = new IntOption(baseConfig, "tier", tier.getSimpleName() + "PipePullAmount", Tier.PipeTier.values()[tier.ordinal()].basePull);
			TubeCapacity = new IntOption(baseConfig, "tier", tier.getSimpleName() + "TubeCapacity", Tier.TubeTier.values()[tier.ordinal()].baseCapacity);
			TubePullAmount = new IntOption(baseConfig, "tier", tier.getSimpleName() + "TubePullAmount", Tier.TubeTier.values()[tier.ordinal()].basePull);
			TransporterPullAmount = new IntOption(baseConfig, "tier", tier.getSimpleName() + "TransporterPullAmount", Tier.TransporterTier.values()[tier.ordinal()].basePull);
			TransporterSpeed = new IntOption(baseConfig, "tier", tier.getSimpleName() + "TransporterSpeed", Tier.TransporterTier.values()[tier.ordinal()].baseSpeed);
			ConductorInverseConduction = new DoubleOption(baseConfig, "tier", tier.getSimpleName() + "ConductorInverseConduction", Tier.ConductorTier.values()[tier.ordinal()].baseConduction);
			ConductorHeatCapacity = new DoubleOption(baseConfig, "tier", tier.getSimpleName() + "ConductorHeatCapacity", Tier.ConductorTier.values()[tier.ordinal()].baseHeatCapacity);
			ConductorConductionInsulation = new DoubleOption(baseConfig, "tier", tier.getSimpleName() + "ConductorConductionInsulation", Tier.ConductorTier.values()[tier.ordinal()].baseConductionInsulation);
