...
public enum MekanismConfigTranslations implements IConfigTranslation {
    ...
    //TODO - 26.3: Do we want to change/move the steam energy density config? Also update all the configs to reference FE instead of joules
    ...
    //TODO - 26.3: Should these two reference to joules go away? It is heat not energy
