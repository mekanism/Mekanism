...
public abstract class BaseConfig
{
	...
	/**
	 * Registers an option to the save/load list.
	 * Should only be used by {@link Option}'s constructor
	 *
	 ...
	 * NB: saving back is done automatically by the config system / GUIs
	 *
