...
public class BlockGasBurningGenerator extends BlockMekanismContainer implements IHasGui, IBlockDescriptive, IRotatableBlock, IBlockElectric, IStateFacing {
    ...
    public BlockGasBurningGenerator() {
        ...
        this.name = "gas_burning_generator";
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityGasGenerator) MekanismUtils.getTileEntitySafe(world, pos));
    }
