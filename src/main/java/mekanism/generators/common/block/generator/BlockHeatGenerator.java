...
public class BlockHeatGenerator extends BlockMekanismContainer implements IHasGui, IBlockDescriptive, IRotatableBlock, IBlockElectric, IStateFacing {
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityHeatGenerator) MekanismUtils.getTileEntitySafe(world, pos));
    }
