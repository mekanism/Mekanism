...
public class BlockAdvancedSolarGenerator extends BlockMekanismContainer implements IHasGui, IBlockDescriptive, IRotatableBlock, IBlockElectric, IStateFacing {
    ...
    public BlockAdvancedSolarGenerator() {
        ...
        this.name = "advanced_solar_generator";
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos pos) {
        return BlockStateHelper.getActualState(this, state, (TileEntityAdvancedSolarGenerator) MekanismUtils.getTileEntitySafe(world, pos));
    }
