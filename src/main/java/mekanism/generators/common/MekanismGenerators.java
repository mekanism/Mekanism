...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "9.2.0", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
