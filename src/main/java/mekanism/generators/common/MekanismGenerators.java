...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "8.1.2", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
