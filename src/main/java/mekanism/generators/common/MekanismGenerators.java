...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "8.0.3", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
