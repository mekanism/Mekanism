...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "9.10.10", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
public class MekanismGenerators implements IModule
{
	...
	public static Version versionNumber = new Version(9, 10, 10);
