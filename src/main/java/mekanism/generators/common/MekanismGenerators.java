...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "9.2.1", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
