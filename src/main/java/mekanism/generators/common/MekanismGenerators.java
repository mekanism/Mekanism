...
@Mod(modid = "mekanismgenerators", name = "MekanismGenerators", version = "9.3.2", dependencies = "required-after:mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
