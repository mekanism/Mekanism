...
@Mod(modid = "mekanismgenerators", name = "MekanismGenerators", version = "9.4.0", dependencies = "required-after:mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory", acceptedMinecraftVersions = "[1.12,1.13)")
