...
@Mod(modid = "mekanismgenerators", name = "MekanismGenerators", version = "9.4.4", dependencies = "required-after:mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory", acceptedMinecraftVersions = "[1.12,1.13)")
...
public class MekanismGenerators implements IModule
{
	...
	public static Version versionNumber = new Version(9, 4, 7);
