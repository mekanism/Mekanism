...
@Mod(modid = "MekanismGenerators", name = "MekanismGenerators", version = "9.10.6", dependencies = "required-after:Mekanism", guiFactory = "mekanism.generators.client.gui.GeneratorsGuiFactory")
