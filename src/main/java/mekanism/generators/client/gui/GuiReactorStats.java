...
public class GuiReactorStats extends GuiReactorInfo {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (tileEntity.isFormed()) {
            drawString(EnumColor.DARK_GREEN + LangUtils.localize("gui.passive"), 6, 26, 0x404040);
            drawString(LangUtils.localize("gui.minInject") + ": " + tileEntity.getReactor().getMinInjectionRate(false), 16, 36, 0x404040);
            drawString(LangUtils.localize("gui.ignition") + ": " +
            ...
            drawString(LangUtils.localize("gui.maxPlasma") + ": " +
            ...
            drawString(LangUtils.localize("gui.maxCasing") + ": " +
            ...
            drawString(LangUtils.localize("gui.passiveGeneration") + ": " +
            ...
            drawString(LangUtils.localize("gui.minInject") + ": " + tileEntity.getReactor().getMinInjectionRate(true), 16, 102, 0x404040);
            drawString(LangUtils.localize("gui.ignition") + ": " +
            ...
            drawString(LangUtils.localize("gui.steamProduction") + ": " + nf.format(tileEntity.getReactor().getSteamPerTick(false)) + "mB/t", 16, 152, 0x404040);
        }
