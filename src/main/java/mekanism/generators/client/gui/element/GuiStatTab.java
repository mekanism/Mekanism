...
public class GuiStatTab extends GuiTabElement<TileEntityReactorController> {

    public GuiStatTab(IGuiWrapper gui, TileEntityReactorController tile, ResourceLocation def) {
        super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "GuiStatsTab.png"), gui, def, tile, 62);
    }
