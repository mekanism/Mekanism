...
public class GuiTurbineStats extends GuiMekanism {
    ...
    public GuiTurbineStats(InventoryPlayer inventory, TileEntityTurbineCasing tentity) {
        ...
        tileEntity = tentity;
        guiElements.add(new GuiTurbineTab(this, tileEntity, TurbineTab.MAIN, 6,
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        boolean dispersersLimiting =
              tileEntity.structure.lowerVolume * tileEntity.structure.clientDispersers * MekanismConfig
        ...
        double rate = tileEntity.structure.lowerVolume * (tileEntity.structure.clientDispersers * MekanismConfig
              .current().generators.turbineDisperserGasFlow.val());
        rate = Math
        ...
        fontRenderer.drawString(
              ...
              8, 104, 0x404040);
        fontRenderer.drawString(
              LangUtils.localize("gui.maxWaterOutput") + ": " + tileEntity.structure.condensers * MekanismConfig
                    .current().generators.condenserRate.val() + " mB/t", 8, 113, 0x404040);
