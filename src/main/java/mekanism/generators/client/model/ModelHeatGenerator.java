...
public class ModelHeatGenerator extends Model {
    ...
    public ModelHeatGenerator() {
        ...
        fin1.mirror = false;
        fin2 = new RendererModel(this, 0, 40);
        ...
        fin2.mirror = false;
        fin3 = new RendererModel(this, 0, 40);
