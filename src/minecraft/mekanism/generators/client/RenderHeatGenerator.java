...
public class RenderHeatGenerator extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((TileEntityHeatGenerator) var1, var2, var4, var6, 1F);
	}
	
	private void renderAModelAt(TileEntityHeatGenerator tileEntity, double x, double y, double z, float f)
	{
		GL11.glPushMatrix();
		GL11.glTranslatef((float) x + 0.5f, (float) y + 1.5f, (float) z + 0.5f);
		bindTextureByName("/mods/mekanism/render/" + (tileEntity.isActive ? "HeatGeneratorOn.png" : "HeatGenerator.png"));
