...
public class ToolsRecipeSerializers {
    ...
    public static final MekanismDeferredHolder<RecipeSerializer<?>, RecipeSerializer<PaxelRecipe>> PAXEL = RECIPE_SERIALIZERS.register("paxel", () -> new WrappedShapedRecipeSerializer<>(PaxelRecipe::new));
}