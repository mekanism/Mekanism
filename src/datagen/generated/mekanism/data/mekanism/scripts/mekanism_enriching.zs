...
// <recipetype:mekanism:enriching>.addRecipe(arg0 as string, arg1 as ItemStackIngredient, arg2 as IItemStack)

<recipetype:mekanism:enriching>.addRecipe("oak_leaves_to_saplings", mekanism.api.ingredient.ItemStackIngredient.from(<item:minecraft:oak_leaves> * 20), <item:minecraft:oak_sapling>);
