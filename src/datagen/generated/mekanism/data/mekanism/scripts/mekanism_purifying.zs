...
// <recipetype:mekanism:purifying>.addRecipe(name as string, itemInput as ItemStackIngredient, chemicalInput as IChemicalStackIngredient, output as IItemStack)
