...
<recipetype:mekanism:activating>.addRecipe("activate_water_vapor", mekanism.api.ingredient.ChemicalStackIngredient.GasStackIngredient.from(<gas:mekanism:water_vapor>), <gas:mekanism:brine>);
