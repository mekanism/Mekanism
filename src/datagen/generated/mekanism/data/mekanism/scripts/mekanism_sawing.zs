...
<recipetype:mekanism:sawing>.addRecipe("sawing/leaves", ItemStackIngredient.from(<tag:items:minecraft:leaves>, 15), <item:mekanism:sawdust>);
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:sawing>.addRecipe("sawing/leaves", <tag:items:minecraft:leaves> * 15, <item:mekanism:sawdust>);
...
<recipetype:mekanism:sawing>.addRecipe("sawing/shield", ItemStackIngredient.from(<item:minecraft:shield>), <item:minecraft:oak_planks> * 4);
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:sawing>.addRecipe("sawing/shield", <item:minecraft:shield>, <item:minecraft:oak_planks> * 4);

<recipetype:mekanism:sawing>.addRecipe("sawing/workbench", ItemStackIngredient.from(<item:minecraft:crafting_table>), <item:minecraft:oak_planks> * 5, <item:mekanism:sawdust>);
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:sawing>.addRecipe("sawing/workbench", <item:minecraft:crafting_table>, <item:minecraft:oak_planks> * 5, <item:mekanism:sawdust>);
