...
// <recipetype:mekanism:sawing>.addRecipe(name as string, input as ItemStackIngredient, output as MCWeightedItemStack)
...
<recipetype:mekanism:sawing>.addRecipe("sawing/melon_to_seeds", ItemStackIngredient.from(<item:minecraft:melon_slice>), <item:minecraft:melon_seeds>.weight(1.0D));
//Alternate implementations of the above recipe are shown commented below. These implementations make use of implicit casting to allow easier calling:
// <recipetype:mekanism:sawing>.addRecipe("sawing/melon_to_seeds", <item:minecraft:melon_slice>, <item:minecraft:melon_seeds>.weight(1.0D));
...
<recipetype:mekanism:sawing>.addRecipe("sawing/shield", ItemStackIngredient.from(<item:minecraft:shield>), <item:minecraft:oak_planks> * 4.weight(1.5D));
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:sawing>.addRecipe("sawing/shield", <item:minecraft:shield>, <item:minecraft:oak_planks> * 4.weight(1.5D));
