...
// <recipetype:mekanism:painting>.addRecipe("paint_sand", <tag:items:forge:sand/colorless> * 1, PigmentStackIngredient.from(<pigment:mekanism:red> * 256), <item:minecraft:red_sand>);
...
// <recipetype:mekanism:painting>.addRecipe("paint_sand", <tag:items:forge:sand/colorless> * 1, <pigment:mekanism:red> * 256, <item:minecraft:red_sand>);
