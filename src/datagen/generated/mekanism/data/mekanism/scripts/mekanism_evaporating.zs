...
<recipetype:mekanism:evaporating>.addRecipe("evaporate_lithium", mekanism.api.ingredient.FluidStackIngredient.from(<tag:fluids:forge:lithium>, 10), <fluid:mekanism:chlorine>);
