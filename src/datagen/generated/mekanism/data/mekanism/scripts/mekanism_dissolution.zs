...
<recipetype:mekanism:dissolution>.addRecipe("salt_to_hydrogen_chloride", mekanism.api.ingredient.ItemStackIngredient.from(<item:mekanism:salt>), mekanism.api.ingredient.ChemicalStackIngredient.GasStackIngredient.from(<gas:mekanism:sulfuric_acid>), <gas:mekanism:hydrogen_chloride> * 10);
//Alternate implementations of the above recipe are shown commented below. These implementations make use of implicit casting to allow easier calling:
// <recipetype:mekanism:dissolution>.addRecipe("salt_to_hydrogen_chloride", <item:mekanism:salt>, mekanism.api.ingredient.ChemicalStackIngredient.GasStackIngredient.from(<gas:mekanism:sulfuric_acid>), <gas:mekanism:hydrogen_chloride> * 10);
// <recipetype:mekanism:dissolution>.addRecipe("salt_to_hydrogen_chloride", mekanism.api.ingredient.ItemStackIngredient.from(<item:mekanism:salt>), <gas:mekanism:sulfuric_acid>, <gas:mekanism:hydrogen_chloride> * 10);
