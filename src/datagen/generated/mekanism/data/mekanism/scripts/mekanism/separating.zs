...
<recipetype:mekanism:separating>.addRecipe("separator/sulfuric_acid", <tag:fluid:c:sulfuric_acid> * 1, <gas:mekanism:water_vapor>, <gas:mekanism:sulfur_trioxide>, FloatingLong.create(1.5000));
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:separating>.addRecipe("separator/sulfuric_acid", <tag:fluid:c:sulfuric_acid> * 1, <gas:mekanism:water_vapor>, <gas:mekanism:sulfur_trioxide>, 1.5);
