...
// <recipetype:mekanism:nucleosynthesizing>.addRecipe(name as string, itemInput as IIngredientWithAmount, chemicalInput as ChemicalStackIngredient, output as IItemStack, duration as int)
