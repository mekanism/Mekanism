...
<recipetype:mekanism:painting>.addRecipe("paint_sand", <tag:items:c:sands/colorless>, PigmentStackIngredient.from(<pigment:mekanism:red> * 256), <item:minecraft:red_sand>);
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
// <recipetype:mekanism:painting>.addRecipe("paint_sand", <tag:items:c:sands/colorless>, <pigment:mekanism:red> * 256, <item:minecraft:red_sand>);
