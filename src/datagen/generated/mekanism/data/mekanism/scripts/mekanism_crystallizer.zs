...
<recipetype:mekanism:crystallizing>.addRecipe("paste_to_carrots", mekanism.api.ingredient.ChemicalStackIngredient.GasStackIngredient.from(<gas:mekanism:nutritional_paste> * 150), <item:minecraft:carrot>);
...
<recipetype:mekanism:crystallizing>.addRecipe("gold_infusion_to_gold", mekanism.api.ingredient.ChemicalStackIngredient.InfusionStackIngredient.from(<tag:infuse_types:mekanism:gold>, 9), <item:minecraft:gold_nugget>);
//An alternate implementation of the above recipe are shown commented below. This implementation makes use of implicit casting to allow easier calling:
