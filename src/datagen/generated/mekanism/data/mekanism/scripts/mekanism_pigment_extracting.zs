...
// <recipetype:mekanism:pigment_extracting>.addRecipe(arg0 as string, arg1 as ItemStackIngredient, arg2 as ICrTPigmentStack)

<recipetype:mekanism:pigment_extracting>.addRecipe("extract_lapis_block_pigment", mekanism.api.ingredient.ItemStackIngredient.from(<tag:items:forge:storage_blocks/lapis>), <pigment:mekanism:blue> * 6912);
