...
<recipetype:mekanism:gas_conversion>.addRecipe("gas_conversion/osmium_from_nugget", ItemStackIngredient.from(<tag:items:forge:nuggets/osmium>), <gas:mekanism:liquid_osmium> * 22);
