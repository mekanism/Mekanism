...
public class PlasticSlabsRecipeProvider implements ISubRecipeProvider {
    ...
    private void registerPlasticSlabs(Consumer<IFinishedRecipe> consumer, Map<EnumColor, ? extends IItemProvider> blocks, Map<EnumColor, ? extends IItemProvider> plastic,
    ...
    private void registerPlasticSlab(Consumer<IFinishedRecipe> consumer, EnumColor color, IItemProvider result, IItemProvider plastic,
          ITag<Item> blockType, boolean transparent, String basePath) {
