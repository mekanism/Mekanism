...
public class MekanismCrTExampleProvider extends BaseCrTExampleProvider {
    ...
    protected void addExamples(HolderLookup.Provider registries) {
        ...
        exampleBuilder("mekanism/jeitweaker_integration")
              ...
              .addComponent(imports -> () -> imports.addImport(EXPANSION_TARGET_JEITWEAKER) + ".addIngredientInformation(" +
                                             new CrTChemicalStack(RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN, FluidType.BUCKET_VOLUME)).getCommandString() +
    ...
    private void addRecipeExamples(HolderLookup.Provider registries) {
        ...
        exampleBuilder("mekanism/crystallizer")
              ...
              .addExample("osmium_ingotification", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OSMIUM, 200),
        ...
        exampleBuilder("mekanism/dissolution")
              ...
              .addExample("salt_to_hydrogen_chloride", IngredientCreatorAccess.item().fromHolder(MekanismItems.SALT), IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.SULFURIC_ACID, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN_CHLORIDE, 10), true)
              .end()
        ...
        exampleBuilder("mekanism/chemical_infusing")
              ...
              .addExample("gaseous_brine", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.HYDROGEN_CHLORIDE, 1), IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.WATER_VAPOR, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.BRINE, 2))
              .end()
        ...
        exampleBuilder("mekanism/separating")
              ...
              .addExample("separator/sulfur_trioxide", IngredientCreatorAccess.fluid().from(fluids, MekanismTags.Fluids.SULFUR_TRIOXIDE, 2),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.OXYGEN, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SULFUR_DIOXIDE, 2))
              .addExample("separator/sulfuric_acid", IngredientCreatorAccess.fluid().from(fluids, MekanismTags.Fluids.SULFURIC_ACID, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.WATER_VAPOR, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SULFUR_TRIOXIDE, 1), 2L)
              .end()
        ...
        exampleBuilder("mekanism/activating")
              ...
              .addExample("activate_water_vapor", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.WATER_VAPOR, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.BRINE, 1))
              .end()
        ...
        exampleBuilder("mekanism/centrifuging")
              ...
              .addExample("centrifuge_brine", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.BRINE, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN_CHLORIDE, 1))
              .end()
        ...
        exampleBuilder("mekanism/compressing")
              ...
              .addExample("compress_emerald", IngredientCreatorAccess.item().from(items, MekanismTags.Items.DUSTS_EMERALD), IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OSMIUM, 1),
        ...
        exampleBuilder("mekanism/purifying")
              ...
              .addExample("purify_basalt", IngredientCreatorAccess.item().from(items, BlockItemIds.BASALT), IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OXYGEN, 1),
        ...
        exampleBuilder("mekanism/metallurgic_infusing")
              ...
              .addExample("infuse_planks", IngredientCreatorAccess.item().from(items, BlockItemIds.OAK_PLANKS), IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.FUNGI, 10),
        ...
        exampleBuilder("mekanism/painting")
              ...
              .addExample("paint_sand", IngredientCreatorAccess.item().from(items, Tags.Items.SANDS_COLORLESS),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.SIMPLE_PIGMENTS.red(), 256),
        ...
        exampleBuilder("mekanism/gas_conversion")
              ...
              .addExample("gas_conversion/osmium_from_nugget", IngredientCreatorAccess.item().from(items, MekanismTags.Items.getProcessedResource(ResourceType.NUGGET, PrimaryResource.OSMIUM)),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.OSMIUM, 22))
              .end()
        ...
        exampleBuilder("mekanism/oxidizing")
              ...
              .addExample("oxidize_salt_block", IngredientCreatorAccess.item().fromHolder(MekanismBlocks.SALT_BLOCK.getItemHolder()), RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.BRINE, 60))
              .end()
        ...
        exampleBuilder("mekanism/infusion_conversion")
              ...
              .blankLine()
              .recipe(ChemicalConversionRecipeManager.INSTANCE)
              .addExample("chemical_conversion/gold/from_ingot", IngredientCreatorAccess.item().from(items, Tags.Items.INGOTS_GOLD), RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.GOLD, 10))
              .end()
        ...
        exampleBuilder("mekanism/pigment_extracting")
              ...
              .addExample("extract_lapis_block_pigment", IngredientCreatorAccess.item().from(items, Tags.Items.STORAGE_BLOCKS_LAPIS),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SIMPLE_PIGMENTS.darkBlue(), 6_912))
              .end()
        ...
        exampleBuilder("mekanism/nucleosynthesizing")
              ...
              .addExample("coal_block_to_diamond_block", IngredientCreatorAccess.item().from(items, Tags.Items.STORAGE_BLOCKS_COAL),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.ANTIMATTER, 36), RecipeProviderUtil.template(items, BlockItemIds.DIAMOND_BLOCK), 9_000, false)
              .end()
        ...
        exampleBuilder("mekanism/pigment_mixing")
              ...
              .addExample("pigment_mixing/white_dark_red_to_red", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.SIMPLE_PIGMENTS.white(), 1),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.SIMPLE_PIGMENTS.darkRed(), 4),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SIMPLE_PIGMENTS.red(), 5))
              .end()
        ...
        exampleBuilder("mekanism/reaction")
              ...
              .addExample("reaction/sawdust", IngredientCreatorAccess.item().from(items, MekanismTags.Items.DUSTS_WOOD), IngredientCreatorAccess.fluid().from(fluids, FluidTags.WATER, 350),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.HYDROGEN_CHLORIDE, 50), 45, RecipeProviderUtil.template(items, ItemIds.PAPER, 2), 25L)
              .addExample("reaction/sand", IngredientCreatorAccess.item().from(items, Tags.Items.SANDS), IngredientCreatorAccess.fluid().from(fluids, MekanismTags.Fluids.CHLORINE, 100),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.HYDROGEN, 100), 300, new ItemStack(MekanismBlocks.SALT_BLOCK))
              .addExample("reaction/wooden_buttons", IngredientCreatorAccess.item().from(items, ItemTags.WOODEN_BUTTONS, 8), IngredientCreatorAccess.fluid().from(fluids, FluidTags.WATER, 25),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OXYGEN, 25), 37, RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN, 25))
              .addExample("reaction/wooden_pressure_plates", IngredientCreatorAccess.item().from(items, ItemTags.WOODEN_PRESSURE_PLATES, 8), IngredientCreatorAccess.fluid().from(fluids, FluidTags.WATER, 50),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OXYGEN, 50), 74, RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN, 50), 100L)
              .addExample("reaction/wooden_fences", IngredientCreatorAccess.item().from(items, ItemTags.WOODEN_FENCES, 20), IngredientCreatorAccess.fluid().from(fluids, FluidTags.WATER, 400),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.OXYGEN, 400), 600, MekanismItems.CHARCOAL_DUST.asTemplate(),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.HYDROGEN, 400),
                    300L)
        ...
        exampleBuilder("mekanism/rotary")
              ...
              .addExample("condensentrate_lithium", IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.LITHIUM, 1), MekanismFluids.LITHIUM.asTemplate(1))
              .addExample("decondensentrate_sulfur_dioxide", IngredientCreatorAccess.fluid().from(fluids, MekanismTags.Fluids.SULFUR_DIOXIDE, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SULFUR_DIOXIDE, 1))
              .addExample("rotary_sulfur_trioxide", IngredientCreatorAccess.fluid().from(fluids, MekanismTags.Fluids.SULFUR_TRIOXIDE, 1),
                    IngredientCreatorAccess.chemicalStack().from(chemicals, ChemicalIds.SULFUR_TRIOXIDE, 1),
                    RecipeProviderUtil.chemicalTemplate(chemicals, ChemicalIds.SULFUR_TRIOXIDE, 1),
