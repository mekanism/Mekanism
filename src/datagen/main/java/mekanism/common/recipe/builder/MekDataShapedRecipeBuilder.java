...
public class MekDataShapedRecipeBuilder extends ExtendedShapedRecipeBuilder {
    ...
    private MekDataShapedRecipeBuilder(Holder<? extends ItemLike> result, int count) {
        super(result, count);
    }

    public static MekDataShapedRecipeBuilder shapedRecipe(Holder<? extends ItemLike> result) {
        return shapedRecipe(result, 1);
    }

    public static MekDataShapedRecipeBuilder shapedRecipe(Holder<? extends ItemLike> result, int count) {
