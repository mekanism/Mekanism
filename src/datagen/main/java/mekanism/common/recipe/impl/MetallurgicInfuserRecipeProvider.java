...
class MetallurgicInfuserRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(RecipeOutput consumer, HolderLookup.Provider registries) {
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.FUNGI, 10),
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.GOLD, 100),
    ...
    private void addMetallurgicInfuserAlloyRecipes(RecipeOutput consumer, String basePath) {
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.REDSTONE, 10),
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.DIAMOND, 20),
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.REFINED_OBSIDIAN, 40),
    ...
    private void addMetallurgicInfuserMossyRecipes(RecipeOutput consumer, String basePath) {
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.BIO, 10),
    ...
    private void addMiscBioRecipes(RecipeOutput consumer, String basePath) {
        ...
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              ...
              IngredientCreatorAccess.chemicalStack().from(MekanismAPITags.InfuseTypes.BIO, 40),
