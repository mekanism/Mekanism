...
class CrusherRecipeProvider implements ISubRecipeProvider {
    ...
    private static void biofuel(RecipeOutput consumer, String basePath, String filename, Holder<Item> bioFuelType, int countOutput, int countInput, TagKey<Item> tag) {
        biofuel(consumer, basePath, filename, bioFuelType, countOutput, IngredientCreatorAccess.item().from(, tag, countInput));
    }
