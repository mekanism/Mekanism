...
class FactoryRecipeProvider extends BaseSubRecipeProvider {

    FactoryRecipeProvider(HolderGetter<Item> items, HolderGetter<Fluid> fluids, HolderGetter<Chemical> chemicals) {
