...
public class MekanismLangProvider extends BaseLanguageProvider {
    ...
    private void addDamageSources() {
        add(MekanismDamageTypes.DISASSEMBLING, "%1$s was disassembled atom by atom.", "%1$s was disassembled at the atomic level by %2$s.",
              "%1$s was disassembled at the atomic level by %2$s using %3$s.");
        add(MekanismDamageTypes.FLAMETHROWER, "%1$s was incinerated.", "%1$s was ruthlessly incinerated by %2$s.",
              "%1$s was ruthlessly incinerated by %2$s using %3$s.");
    ...
    private void addMisc() {
        ...
        //Upgrades
        addUpgrade(UpgradeIds.SPEED, "Speed", "Increases speed of machinery.");
        addUpgrade(UpgradeIds.ENERGY, "Energy", "Increases energy efficiency and capacity of machinery.");
        addUpgrade(UpgradeIds.FILTER, "Filter", "A filter that separates heavy water from regular water.");
        addUpgrade(UpgradeIds.CHEMICAL, "Chemical", "Increases the efficiency of chemical-using machinery.");
        addUpgrade(UpgradeIds.MUFFLING, "Muffling", "Reduces noise generated by machinery.");
        addUpgrade(UpgradeIds.ANCHOR, "Anchor", "Keeps a machine's chunk loaded.");
        addUpgrade(UpgradeIds.STONE_GENERATOR, "Stone Generator", "Generates stone or cobblestone as needed.");
        add(MekanismLang.TOOLTIP_UPGRADE_TYPE, "Upgrade Type: %1$s");
        add(MekanismLang.TOOLTIP_UPGRADE_MAX_INSTALLED, "Maximum Installed: %1$s");
        //Transmission types
