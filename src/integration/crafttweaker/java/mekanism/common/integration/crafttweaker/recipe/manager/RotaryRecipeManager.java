...
public class RotaryRecipeManager extends MekanismRecipeManager<RotaryRecipeInput, RotaryRecipe> {
    ...
    /// @param fluidInput     [CTFluidIngredient] representing the input of the recipe.
    /// @param chemicalOutput [ICrTChemicalStack] representing the output of the recipe.
    ///
    /// @apiNote It is recommended to use [#addRecipe(String, CTFluidIngredient, ChemicalStackIngredient, ICrTChemicalStack, IFluidStack)] over this method in combination
    /// with [#addRecipe(String, ChemicalStackIngredient, IFluidStack)] if the conversion will be possible in both directions.
    @ZenCodeType.Method
    ...
    ///
    /// @param name          Name of the new recipe.
    /// @param chemicalInput [CTFluidIngredient] representing the input of the recipe.
    /// @param fluidOutput   [IFluidStack] representing the output of the recipe.
    ///
    /// @apiNote It is recommended to use [#addRecipe(String, CTFluidIngredient, ChemicalStackIngredient, ICrTChemicalStack, IFluidStack)] over this method in combination
    /// with [#addRecipe(String, CTFluidIngredient, ICrTChemicalStack)] if the conversion will be possible in both directions.
    @ZenCodeType.Method
    ...
    ///
    /// @param name           Name of the new recipe.
    /// @param fluidInput     [CTFluidIngredient] representing the input of the recipe when converting from a fluid to a chemical.
    /// @param chemicalInput  [ChemicalStackIngredient] representing the input of the recipe when converting from a chemical to a fluid.
    /// @param chemicalOutput [ICrTChemicalStack] representing the output of the recipe when converting from a fluid to a chemical.
    /// @param fluidOutput    [IFluidStack] representing the output of the recipe when converting from a chemical to a fluid.
    ///
    /// @apiNote It is recommended to use this method over using [#addRecipe(String, CTFluidIngredient, ICrTChemicalStack)] and
    ///
    /// [#addRecipe(String, ChemicalStackIngredient, IFluidStack)] in combination if the conversion will be possible in both directions.
    @ZenCodeType.Method
    ...
    ///
    /// @param fluidInput     [CTFluidIngredient] representing the input of the recipe.
    /// @param chemicalOutput [ICrTChemicalStack] representing the output of the recipe. Will be validated as not empty.
    ...
    ///
    /// @param chemicalInput [ChemicalStackIngredient] representing the input of the recipe.
    /// @param fluidOutput   [IFluidStack] representing the output of the recipe. Will be validated as not empty.
    ...
    /// @param fluidInput     [CTFluidIngredient] representing the input of the recipe when converting from a fluid to a chemical.
    /// @param chemicalInput  [ChemicalStackIngredient] representing the input of the recipe when converting from a chemical to a fluid.
    /// @param chemicalOutput [ICrTChemicalStack] representing the output of the recipe when converting from a fluid to a chemical. Will be validated as not empty.
    /// @param fluidOutput    [IFluidStack] representing the output of the recipe when converting from a chemical to a fluid. Will be validated as not empty.
