...
public enum EnumColor {//TODO: Maybe rename some of these or their lang keys
    ...
    DARK_RED("\u00a74", APILang.COLOR_DARK_RED, "Dark Red", null, "dark_red", new int[]{170, 0, 0}, TextFormatting.DARK_RED, MaterialColor.NETHERRACK),
    ...
    AQUA("\u00a7b", APILang.COLOR_AQUA, "Aqua", null, "aqua", new int[]{85, 255, 255}, TextFormatting.AQUA, MaterialColor.LIGHT_BLUE),
    ...
    EnumColor(String s, APILang langEntry, String englishName, String dyeName, String registryPrefix, int[] rgbCode, TextFormatting textFormatting, DyeColor dyeColor) {
        this(s, langEntry, englishName, dyeName, registryPrefix, rgbCode, textFormatting, dyeColor.getMapColor());
    }

    EnumColor(String code, APILang langEntry, String englishName, String dyeName, String registryPrefix, int[] rgbCode, TextFormatting textFormatting, MaterialColor mapColor) {
        this.code = code;
