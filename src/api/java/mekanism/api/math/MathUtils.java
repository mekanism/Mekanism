...
public class MathUtils {
    ...
    /// Clamp a double to int without using[Math#min(double, double)] due to double representation issues. Primary use: power systems that use int, where Mek uses doubles
    /// internally
    /// ```
    ...
    ///
    /// @see [Original PR](https://github.com/aidancbrady/Mekanism/pull/5203)
    ...
    /// @param d double to clamp
    ///
    /// @return a long clamped to [Long#MAX_VALUE]
    ///
    /// @see com.google.common.primitives.Ints#saturatedCast(long)
    ...
    /// Divides numerator by the given toDivide and returns the result as a double. Additionally, if the value to divide by is zero, this returns `1`
    ///
    /// @param numerator The numerator of the division.
    /// @param toDivide  The denominator of the division.
    ///
    /// @return A double representing the value of dividing numerator by toDivide, or `1` if the given toDivide is `0`.
    ///
    ...
    /// Like [Math#addExact(long, long)] but clamps to max long instead of throwing
    ///
    ...
    /// Like [Math#multiplyExact(long, long)] but clamps to max long instead of throwing
    ///
    ...
    /// Like [Math#addExact(int, int)] but clamps to max int instead of throwing
    ///
    /// @param x the first value
    /// @param y the second value
    ///
    ...
    /// Like [Math#multiplyExact(int, int)] but clamps to max int instead of throwing
    ///
    /// @param x the first value. should be positive
    /// @param y the second value. should be positive
    ///
