...
public class ModuleColorConfig extends ModuleConfig<Integer> {
    ...
    private ModuleColorConfig(Identifier name, boolean supportsAlpha, int value) {
        super(name);
    ...
    @Override
    public StreamCodec<ByteBuf, ModuleConfig<Integer>> namedStreamCodec(Identifier name) {
        if (supportsAlpha) {
