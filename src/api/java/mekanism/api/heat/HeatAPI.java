...
public class HeatAPI {
    ...
    ///
    /// @param world World; if `null` [#AMBIENT_TEMP] is returned instead.
    /// @param pos   Position in the world.
    ///
    /// @return Atmospheric temperature at the given position.
    ///
    /// @implNote This method is a helper to call [#getAmbientTemp(double)] using the temperature of the biome at the location specified.
    /// @see #AMBIENT_TEMP
    ...
    /// Gets the atmospheric temperature based on the temperature modifier of a [net.minecraft.world.level.biome.Biome], with the baseline being the same as the plains
    /// biome, or 0.8.
    ///
    ...
    public static double getAmbientTemp(double biomeTemp) {
        ...
        biomeTemp = Math.clamp(biomeTemp, -5, 5);
