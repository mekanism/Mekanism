...
public interface IFluidStackIngredientCreator extends IIngredientCreator<Fluid, FluidResource, FluidStack, FluidStackIngredient> {
    ...
    default FluidStackIngredient from(FluidStack instance) {
        ...
        if (predicate != null) {
            return from(DataComponentFluidIngredient.of(false, predicate, instance.typeHolder()), instance.amount());
        }
        return from(SizedFluidIngredient.of(instance.getFluid(), instance.amount()));
    }
