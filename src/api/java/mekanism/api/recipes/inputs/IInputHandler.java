...
public interface IInputHandler<HOLDER_TYPE, STACK extends TypedInstance<HOLDER_TYPE>> {
    ...
    ///
    /// **IMPORTANT:** This input _MUST NOT_ be modified. This method is not for altering an input's contents. Any implementers who are able to detect modification
    /// through this method should throw an exception.
    ///
    /// **_SERIOUSLY: DO NOT MODIFY THE RETURNED INPUT_**
    ///
    /// @return Input stored.
    ///
    /// @apiNote **IMPORTANT:** Do not modify this value.
    STACK getInput();
    ...
    /// @param recipeInput Recipe input gotten from [#getRecipeInput(InputIngredient)].
