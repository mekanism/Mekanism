...
public interface IMekanismInfusionHandler extends ISidedInfusionHandler {
     ...
     *
     * @apiNote If for some reason you are comparing to {@link IMekanismInfusionHandler} without having gotten the object via the item handler capability, then you must
     * call this method to make sure that it really is an inventory. As most mekanism tiles have this class in their hierarchy.
