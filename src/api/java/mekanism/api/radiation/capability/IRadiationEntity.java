...
///
/// @implNote Builtin Mekanism implementations of this are backed by an [`AttachmentType< Double >`][net.neoforged.neoforge.attachment.AttachmentType] with the registry
/// name `mekanism:radiation`, though it is recommended to interact with this via capabilities.
