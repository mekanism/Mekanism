...
/// Helper for interacting with Mekanism's internals related to EMI. Get an instance via [mekanism.api.IMekanismAccess#emiHelper()] after ensuring that EMI is loaded.
///
/// @since 10.5.10
public interface IMekanismEmiHelper {
    ...
    default EmiStack createEmiStack(ChemicalStack stack) {
        return createEmiStack(stack.typeHolder(), stack.amount());
    }
