...
public class ConstantPredicates {
    ...
    /// A boolean supplier that returns `true`.
    ///
    /// @since 10.5.0
    ...
    /// Returns a predicate that returns `true` for any input.
    public static <T extends @Nullable Object> Predicate<T> alwaysTrue() {
        return (Predicate<T>) alwaysTrue;
    }

    /// Returns a bi predicate that returns `true` for any input.
    ...
    /// Returns a predicate that returns `false` for any input.
    public static <T extends @Nullable Object> Predicate<T> alwaysFalse() {
        return (Predicate<T>) alwaysFalse;
    }

    /// Returns a bi predicate that returns `false` for any input.
    ...
    /// Returns a bi predicate that returns `true` for any input when the automation type is internal.
    ///
    /// @since 10.3.3
    ...
    /// Returns a bi predicate that returns `true` for any input when the automation type is not external.
    ///
    /// @since 10.3.3
    ...
    /// Returns a bi predicate that returns `true` for any input when the automation type is manual.
    ///
    /// @since 10.7.0
