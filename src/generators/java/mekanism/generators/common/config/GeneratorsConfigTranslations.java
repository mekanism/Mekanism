...
public enum GeneratorsConfigTranslations implements IConfigTranslation {
    SERVER_GENERATOR_SOLAR("server.generator.solar", "Solar Generator Settings", "Settings for configuring Solar Generators"),
    ...
    SERVER_GENERATOR_BIO("server.generator.bio", "Bio Generator Settings", "Settings for configuring Bio Generators"),
    ...
    SERVER_GENERATOR_HEAT("server.generator.heat", "Heat Generator Settings", "Settings for configuring Heat Generators"),
    ...
    SERVER_GENERATOR_GAS("server.generator.gas", "Gas-Burning Generator Settings", "Settings for configuring Gas-Burning Generators"),
    SERVER_GENERATOR_GAS_TANK_CAPACITY("server.generator.gas.tank_capacity", "Tank Capacity", "The capacity in mB of the gas tank in the Gas-Burning Generator."),
    ...
    SERVER_GENERATOR_WIND("server.generator.wind", "Wind Generator Settings", "Settings for configuring Wind Generators"),
    ...
    SERVER_TURBINE("server.turbine", "Turbine Settings", "Settings for configuring Industrial Turbines"),
    ...
    SERVER_TURBINE_GAS_CAPACITY("server.turbine.capacity.gas", "Gas Per Tank",
          "Amount of gas (mB) that each block of the turbine's steam cavity contributes to the volume. Max = volume * gasPerTank"),

    SERVER_FISSION("server.fission", "Fission Settings", "Settings for configuring Fission Reactors"),
    ...
    SERVER_FISSION_MELTDOWNS("server.fission.meltdowns", "Meltdowns", "Settings for configuring Fission Reactor Meltdowns."),
    ...
    SERVER_FUSION("server.fusion", "Fusion Settings", "Settings for configuring Fusion Reactors"),
    ...
    SERVER_HOHLRAUM("server.hohlraum", "Hohlraum Settings", "Settings for configuring Hohlraum"),
