...
public class GeneratorsConfig extends BaseMekanismConfig {
    ...
    GeneratorsConfig() {
        ...
        fusionCasingThermalConductivity = CachedDoubleValue.wrap(this, builder.comment("The fraction of heat from the casing that can be transferred to all sources that are not water. Will impact max heat, heat transfer to thermodynamic conductors, and power generation.")
