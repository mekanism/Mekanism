...
public class BlockLaserFocusMatrix extends BlockMekanism implements IHasTileEntity<TileEntityLaserFocusMatrix>, IHasDescription {
    ...
    @Override
    public TileEntityType<TileEntityLaserFocusMatrix> getTileType() {
