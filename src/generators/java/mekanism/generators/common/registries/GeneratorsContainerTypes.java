...
public class GeneratorsContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<EmptyTileContainer<TileEntityReactorController>> REACTOR_FUEL = CONTAINER_TYPES.register("reactor_fuel", ReactorFuelTabContainer::new);
    public static final ContainerTypeRegistryObject<EmptyTileContainer<TileEntityReactorController>> REACTOR_HEAT = CONTAINER_TYPES.register("reactor_heat", ReactorHeatTabContainer::new);
