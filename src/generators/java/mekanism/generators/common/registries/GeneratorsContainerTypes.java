...
public class GeneratorsContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<EmptyTileContainer<TileEntityFissionReactorCasing>> FISSION_REACTOR = CONTAINER_TYPES.register("fission_reactor", FissionReactorContainer::new);
