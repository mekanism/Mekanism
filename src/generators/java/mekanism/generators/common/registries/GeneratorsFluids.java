...
public class GeneratorsFluids {
    ...
    public static final FluidRegistryObject<Source, Flowing, FlowingFluidBlock, BucketItem> DEUTERIUM = FLUIDS.registerLiquidChemical(ChemicalConstants.DEUTERIUM);
