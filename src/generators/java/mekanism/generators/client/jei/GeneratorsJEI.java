...
public class GeneratorsJEI implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registry) {
        ...
        GasToGasRecipe recipe = new GasToGasRecipe(MekanismGenerators.rl("processing/fissile_fuel"),
              GasStackIngredient.from(MekanismGases.FISSILE_FUEL, 1),
              MekanismGases.NUCLEAR_WASTE.getStack(1)) {
            @Nonnull
            @Override
        ...
        registry.addRecipes(Collections.singletonList(recipe), FISSION);
    }
}