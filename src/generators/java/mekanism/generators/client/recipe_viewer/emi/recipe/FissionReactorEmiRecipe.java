...
public class FissionReactorEmiRecipe extends MekanismEmiRecipe<FissionRecipeViewerRecipe> {
    ...
    public void addWidgets(WidgetHolder widgetHolder) {
        ...
        initTank(widgetHolder, GuiGasGauge.getDummy(GaugeType.STANDARD, this, 152, 13).setLabel(GeneratorsLang.FISSION_HEATED_COOLANT_TANK.translateColored(EnumColor.GRAY)), output(0));
        initTank(widgetHolder, GuiGasGauge.getDummy(GaugeType.STANDARD, this, 171, 13).setLabel(GeneratorsLang.FISSION_WASTE_TANK.translateColored(EnumColor.BROWN)), output(1));
    }
}