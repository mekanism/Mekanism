...
public class ModelSolarGenerator extends Model {
    ...
    public ModelSolarGenerator() {
        ...
        solarPanel = new RendererModel(this, 0, 0);
        ...
        solarPanelBottom = new RendererModel(this, 0, 18);
        ...
        solarPanelConnector = new RendererModel(this, 0, 33);
        ...
        solarPanelRod2 = new RendererModel(this, 16, 33);
        ...
        solarPanelPipeConnector = new RendererModel(this, 24, 33);
        ...
        solarPanelPort = new RendererModel(this, 0, 44);
        ...
        solarPanelRod1 = new RendererModel(this, 16, 33);
        ...
        solarPanelPipeBase = new RendererModel(this, 0, 39);
