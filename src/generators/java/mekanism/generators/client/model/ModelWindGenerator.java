...
public class ModelWindGenerator extends Model {
    ...
    public void render(@Nonnull MatrixStack matrix, @Nonnull IVertexBuilder vertexBuilder, int light, int overlayLight, float red, float green, float blue, float alpha) {
        ...
        plateConnector2.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        plateConnector.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        plate.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        baseRim.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        base.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        wire.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        rearPlate1.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        rearPlate2.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        post1a.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        post1b.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        post1c.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        post1d.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);

        blade1a.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        blade2a.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        blade3a.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        blade1b.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        blade2b.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        blade3b.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);

        bladeCap.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
        bladeCenter.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
    }
