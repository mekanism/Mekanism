...
public class ModelWindGenerator extends Model {
    ...
    RendererModel head;
    RendererModel plateConnector2;
    RendererModel plateConnector;
    RendererModel plate;
    RendererModel bladeCap;
    RendererModel bladeCenter;
    RendererModel baseRim;
    RendererModel base;
    RendererModel wire;
    RendererModel rearPlate1;
    RendererModel rearPlate2;
    RendererModel blade1a;
    RendererModel blade2a;
    RendererModel blade3a;
    RendererModel blade1b;
    RendererModel blade2b;
    RendererModel blade3b;
    RendererModel post1a;
    RendererModel post1b;
    RendererModel post1c;
    RendererModel post1d;

    public ModelWindGenerator() {
        textureWidth = 128;
        textureHeight = 128;

        head = new RendererModel(this, 20, 0);
        head.addBox(-3.5F, -3.5F, 0F, 7, 7, 9);
        head.setRotationPoint(0F, -48F, -4F);
        head.setTextureSize(128, 128);
        head.mirror = true;
        setRotation(head, 0F, 0F, 0F);
        plateConnector2 = new RendererModel(this, 42, 34);
        ...
        plateConnector = new RendererModel(this, 0, 75);
        ...
        bladeCenter = new RendererModel(this, 20, 25);
        ...
        baseRim = new RendererModel(this, 26, 50);
        ...
        rearPlate1 = new RendererModel(this, 20, 16);
        ...
        rearPlate2 = new RendererModel(this, 36, 16);
        ...
        blade1a = new RendererModel(this, 20, 32);
        ...
        blade2a = new RendererModel(this, 20, 32);
        ...
        blade3a = new RendererModel(this, 20, 32);
        ...
        blade1b = new RendererModel(this, 26, 32);
        ...
        blade2b = new RendererModel(this, 26, 32);
        ...
        blade3b = new RendererModel(this, 26, 32);
        ...
        post1a = new RendererModel(this, 0, 0);
        ...
        post1b = new RendererModel(this, 0, 0);
        ...
        post1c = new RendererModel(this, 0, 0);
        ...
        post1d = new RendererModel(this, 0, 0);
