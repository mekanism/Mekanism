...
public class GuiFissionReactor extends GuiMekanismTile<TileEntityFissionReactorCasing, EmptyTileContainer<TileEntityFissionReactorCasing>> {
    ...
    public void init() {
        super.init();
        addButton(new GuiInnerScreen(this, 45, 17, 104, 56));
        ...
        addButton(new GuiDynamicHorizontalRateBar(this, new IBarInfoHandler() {
            ...
            public double getLevel() {
                return 1;//Math.min(1, tile.getTemperature() / SynchronizedFissionReactorData.MAX_DAMAGE_TEMPERATURE);
            }
        }, 5, 104, xSize - 12));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        renderScaledText(MekanismLang.STATUS.translate(ActiveDisabled.of(tile.isReactorActive())), 48, 20, 0x00CD00, 90);
        renderScaledText(MekanismLang.TEMPERATURE.translate(tile.getTempColor(),MekanismUtils.getTemperatureDisplay(tile.getTemperature(), TemperatureUnit.KELVIN, true)), 48, 29, 0x00CD00, 90);
        renderScaledText(MekanismLang.BOIL_RATE.translate(tile.getLastBoilRate()), 48, 38, 0x00CD00, 90);
        renderScaledText(GeneratorsLang.FISSION_DAMAGE.translate(tile.getDamageColor(), tile.getDamageString()), 48, 47, 0x00CD00, 90);
